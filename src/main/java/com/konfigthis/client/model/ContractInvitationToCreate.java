...
public class ContractInvitationToCreate {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Message for the worker.")
   ...
   * @return the ContractInvitationToCreate instance itself
   */
  public ContractInvitationToCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, contractInvitationToCreate.email) &&
        ...
        Objects.equals(this.additionalProperties, contractInvitationToCreate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, message, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContractInvitationToCreate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContractInvitationToCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContractInvitationToCreate>() {
           ...
           public ContractInvitationToCreate read(JsonReader in) throws IOException {
             ...
             ContractInvitationToCreate instance = thisAdapter.fromJsonTree(jsonObj);
