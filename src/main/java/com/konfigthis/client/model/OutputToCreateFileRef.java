...
public class OutputToCreateFileRef {
  ...
  **/
   ...
   * @return the OutputToCreateFileRef instance itself
   */
  public OutputToCreateFileRef putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, outputToCreateFileRef.key) &&
        ...
        Objects.equals(this.additionalProperties, outputToCreateFileRef.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, url, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OutputToCreateFileRef
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OutputToCreateFileRef.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OutputToCreateFileRef>() {
           ...
           public OutputToCreateFileRef read(JsonReader in) throws IOException {
             ...
             OutputToCreateFileRef instance = thisAdapter.fromJsonTree(jsonObj);
