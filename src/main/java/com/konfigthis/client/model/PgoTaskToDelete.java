...
public class PgoTaskToDelete {
  ...
  **/
  ...
  @ApiModelProperty(value = "Description of exclusion.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Request to delete recurring report.")
   ...
   * @return the PgoTaskToDelete instance itself
   */
  public PgoTaskToDelete putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, pgoTaskToDelete.description) &&
        ...
        Objects.equals(this.additionalProperties, pgoTaskToDelete.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, deleteRecurringReport, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PgoTaskToDelete
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PgoTaskToDelete.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PgoTaskToDelete>() {
           ...
           public PgoTaskToDelete read(JsonReader in) throws IOException {
             ...
             PgoTaskToDelete instance = thisAdapter.fromJsonTree(jsonObj);
