...
public class PeopleContainer {
  ...
  **/
   ...
   * @return the PeopleContainer instance itself
   */
  public PeopleContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, peopleContainer.data) &&
        ...
        Objects.equals(this.additionalProperties, peopleContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PeopleContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PeopleContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        Employee.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PeopleContainer>() {
           ...
           public PeopleContainer read(JsonReader in) throws IOException {
             ...
             PeopleContainer instance = thisAdapter.fromJsonTree(jsonObj);
