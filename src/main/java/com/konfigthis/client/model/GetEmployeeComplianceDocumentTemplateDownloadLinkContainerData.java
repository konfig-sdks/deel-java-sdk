...
public class GetEmployeeComplianceDocumentTemplateDownloadLinkContainerData {
  ...
  **/
  ...
  @ApiModelProperty(example = "https://s3URL/letsdeel.com/contract_requirement_templates/12345.pdf", value = "The URL for the requested compliance document template.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2020-03-31T10:58:49.780Z", value = "Expiration date time of download URL.")
   ...
   * @return the GetEmployeeComplianceDocumentTemplateDownloadLinkContainerData instance itself
   */
  public GetEmployeeComplianceDocumentTemplateDownloadLinkContainerData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, getEmployeeComplianceDocumentTemplateDownloadLinkContainerData.url) &&
        ...
        Objects.equals(this.additionalProperties, getEmployeeComplianceDocumentTemplateDownloadLinkContainerData.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetEmployeeComplianceDocumentTemplateDownloadLinkContainerData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetEmployeeComplianceDocumentTemplateDownloadLinkContainerData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetEmployeeComplianceDocumentTemplateDownloadLinkContainerData>() {
           ...
           public GetEmployeeComplianceDocumentTemplateDownloadLinkContainerData read(JsonReader in) throws IOException {
             ...
             GetEmployeeComplianceDocumentTemplateDownloadLinkContainerData instance = thisAdapter.fromJsonTree(jsonObj);
