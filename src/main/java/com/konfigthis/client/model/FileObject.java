 ...
 */
@ApiModel(description = "This is the file you will upload in a multi-part form.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FileObject {
  ...
  **/
   ...
   * @return the FileObject instance itself
   */
  public FileObject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._file, fileObject._file)&&
        Objects.equals(this.additionalProperties, fileObject.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FileObject>() {
           ...
           public FileObject read(JsonReader in) throws IOException {
             ...
             FileObject instance = thisAdapter.fromJsonTree(jsonObj);
