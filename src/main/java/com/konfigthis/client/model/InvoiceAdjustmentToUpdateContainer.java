...
public class InvoiceAdjustmentToUpdateContainer {
  ...
  **/
   ...
   * @return the InvoiceAdjustmentToUpdateContainer instance itself
   */
  public InvoiceAdjustmentToUpdateContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, invoiceAdjustmentToUpdateContainer.data)&&
        Objects.equals(this.additionalProperties, invoiceAdjustmentToUpdateContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceAdjustmentToUpdateContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceAdjustmentToUpdateContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      InvoiceAdjustmentToUpdate.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InvoiceAdjustmentToUpdateContainer>() {
           ...
           public InvoiceAdjustmentToUpdateContainer read(JsonReader in) throws IOException {
             ...
             InvoiceAdjustmentToUpdateContainer instance = thisAdapter.fromJsonTree(jsonObj);
