...
public class PremiumResultAddedThirdPartyLiabilities {
  ...
  **/
  ...
  @ApiModelProperty(value = "Get indemnity against third parties up to $10k depending on the court's decision.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Third-party liabilities.")
   ...
   * @return the PremiumResultAddedThirdPartyLiabilities instance itself
   */
  public PremiumResultAddedThirdPartyLiabilities putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, premiumResultAddedThirdPartyLiabilities.description) &&
        Objects.equals(this.name, premiumResultAddedThirdPartyLiabilities.name)&&
        Objects.equals(this.additionalProperties, premiumResultAddedThirdPartyLiabilities.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PremiumResultAddedThirdPartyLiabilities
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PremiumResultAddedThirdPartyLiabilities.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PremiumResultAddedThirdPartyLiabilities>() {
           ...
           public PremiumResultAddedThirdPartyLiabilities read(JsonReader in) throws IOException {
             ...
             PremiumResultAddedThirdPartyLiabilities instance = thisAdapter.fromJsonTree(jsonObj);
