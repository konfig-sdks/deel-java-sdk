...
public class GPContractToCreateEmployeeAddress {
  ...
  **/
  ...
  @ApiModelProperty(example = "Deel Street 500", required = true, value = "Street and number.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Denver", required = true, value = "City name.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "44000", required = true, value = "Zip code.")
  ...
  **/
   ...
   * @return the GPContractToCreateEmployeeAddress instance itself
   */
  public GPContractToCreateEmployeeAddress putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.street, gpContractToCreateEmployeeAddress.street) &&
        ...
        Objects.equals(this.additionalProperties, gpContractToCreateEmployeeAddress.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GPContractToCreateEmployeeAddress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GPContractToCreateEmployeeAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GPContractToCreateEmployeeAddress>() {
           ...
           public GPContractToCreateEmployeeAddress read(JsonReader in) throws IOException {
             ...
             GPContractToCreateEmployeeAddress instance = thisAdapter.fromJsonTree(jsonObj);
