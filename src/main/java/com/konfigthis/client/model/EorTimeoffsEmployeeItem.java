...
public class EorTimeoffsEmployeeItem {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Steve Timeoff", required = true, value = "")
  ...
  public EorTimeoffsEmployeeItem eorContractId(Double eorContractId) {
  ...
  public EorTimeoffsEmployeeItem eorContractId(Integer eorContractId) {
    
    
    
    
    this.eorContractId = eorContractId.doubleValue();
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "110143", required = true, value = "")

  public Double getEorContractId() {
    return eorContractId;
  }


  public void setEorContractId(Double eorContractId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "7WjJWdsJ113vocUN6Buwn", required = true, value = "")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "List of employee vacation time offs.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "List of employee sick leave time offs.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "List of all other employee time offs.")
  ...
  **/
   ...
   * @return the EorTimeoffsEmployeeItem instance itself
   */
  public EorTimeoffsEmployeeItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, eorTimeoffsEmployeeItem.id) &&
        ...
        Objects.equals(this.additionalProperties, eorTimeoffsEmployeeItem.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, eorContractId, contractId, vacations, sickLeaves, others, timeZones, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EorTimeoffsEmployeeItem
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EorTimeoffsEmployeeItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (int i = 0; i < jsonArrayvacations.size(); i++) {
        EorClientTimeoffRequests.validateJsonObject(jsonArrayvacations.get(i).getAsJsonObject());
      };
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArraysickLeaves.size(); i++) {
        EorClientTimeoffRequests.validateJsonObject(jsonArraysickLeaves.get(i).getAsJsonObject());
      };
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArrayothers.size(); i++) {
        EorClientTimeoffRequests.validateJsonObject(jsonArrayothers.get(i).getAsJsonObject());
      };
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EorTimeoffsEmployeeItem>() {
           ...
           public EorTimeoffsEmployeeItem read(JsonReader in) throws IOException {
             ...
             EorTimeoffsEmployeeItem instance = thisAdapter.fromJsonTree(jsonObj);
