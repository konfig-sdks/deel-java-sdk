...
public class TimeoffReviewInternal {
  ...
  **/
  ...
  @ApiModelProperty(example = "APPROVED", required = true, value = "The review decision to review the time off request with")
  ...
  **/
  ...
  @ApiModelProperty(example = "Approved because there are no conflicts.", value = "The reason that the chosen status was chosen.")
   ...
   * @return the TimeoffReviewInternal instance itself
   */
  public TimeoffReviewInternal putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, timeoffReviewInternal.status) &&
        ...
        Objects.equals(this.additionalProperties, timeoffReviewInternal.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, reason, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimeoffReviewInternal
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimeoffReviewInternal.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TimeoffReviewInternal>() {
           ...
           public TimeoffReviewInternal read(JsonReader in) throws IOException {
             ...
             TimeoffReviewInternal instance = thisAdapter.fromJsonTree(jsonObj);
