...
import com.konfigthis.client.model.HrisDirectEmployeeResponse;
...
public class HrisDirectEmployeeContainer {
  ...
  **/
   ...
   * @return the HrisDirectEmployeeContainer instance itself
   */
  public HrisDirectEmployeeContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, hrisDirectEmployeeContainer.data)&&
        Objects.equals(this.additionalProperties, hrisDirectEmployeeContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to HrisDirectEmployeeContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HrisDirectEmployeeContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      HrisDirectEmployeeResponse.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<HrisDirectEmployeeContainer>() {
           ...
           public HrisDirectEmployeeContainer read(JsonReader in) throws IOException {
             ...
             HrisDirectEmployeeContainer instance = thisAdapter.fromJsonTree(jsonObj);
