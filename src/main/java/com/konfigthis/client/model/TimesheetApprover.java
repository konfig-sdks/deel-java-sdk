...
public class TimesheetApprover {
  ...
  **/
   ...
   * @return the TimesheetApprover instance itself
   */
  public TimesheetApprover putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fullName, timesheetApprover.fullName) &&
        ...
        Objects.equals(this.additionalProperties, timesheetApprover.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetApprover
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetApprover.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TimesheetApprover>() {
           ...
           public TimesheetApprover read(JsonReader in) throws IOException {
             ...
             TimesheetApprover instance = thisAdapter.fromJsonTree(jsonObj);
