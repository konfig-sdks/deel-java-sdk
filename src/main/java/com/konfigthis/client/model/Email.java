...
public class Email {
  ...
  **/
  ...
  @ApiModelProperty(example = "WORK", required = true, value = "The type of email.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "work.email@example.com", required = true, value = "The email address.")
