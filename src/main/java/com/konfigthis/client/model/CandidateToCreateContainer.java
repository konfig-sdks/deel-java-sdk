...
public class CandidateToCreateContainer {
  ...
  **/
   ...
   * @return the CandidateToCreateContainer instance itself
   */
  public CandidateToCreateContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, candidateToCreateContainer.data)&&
        Objects.equals(this.additionalProperties, candidateToCreateContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CandidateToCreateContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CandidateToCreateContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      CandidateToCreate.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CandidateToCreateContainer>() {
           ...
           public CandidateToCreateContainer read(JsonReader in) throws IOException {
             ...
             CandidateToCreateContainer instance = thisAdapter.fromJsonTree(jsonObj);
