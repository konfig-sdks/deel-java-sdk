...
public class PageInfoWithoutCursorNew {
  ...
  public PageInfoWithoutCursorNew totalRows(Double totalRows) {
  ...
  public PageInfoWithoutCursorNew totalRows(Integer totalRows) {
  ...
  **/
  ...
  public PageInfoWithoutCursorNew itemsPerPage(Double itemsPerPage) {
  ...
  public PageInfoWithoutCursorNew itemsPerPage(Integer itemsPerPage) {
    if (itemsPerPage != null && itemsPerPage < 1) {
      throw new IllegalArgumentException("Invalid value for itemsPerPage. Must be greater than or equal to 1.");
    }
    if (itemsPerPage != null && itemsPerPage > 99) {
  ...
  **/
  ...
  public PageInfoWithoutCursorNew offset(Double offset) {
  ...
  public PageInfoWithoutCursorNew offset(Integer offset) {
    if (offset != null && offset < 0) {
      throw new IllegalArgumentException("Invalid value for offset. Must be greater than or equal to 0.");
    }
    if (offset != null && offset > 999999999) {
  ...
  **/
   ...
   * @return the PageInfoWithoutCursorNew instance itself
   */
  public PageInfoWithoutCursorNew putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalRows, pageInfoWithoutCursorNew.totalRows) &&
        ...
        Objects.equals(this.additionalProperties, pageInfoWithoutCursorNew.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(totalRows, itemsPerPage, offset, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PageInfoWithoutCursorNew
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PageInfoWithoutCursorNew.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PageInfoWithoutCursorNew>() {
           ...
           public PageInfoWithoutCursorNew read(JsonReader in) throws IOException {
             ...
             PageInfoWithoutCursorNew instance = thisAdapter.fromJsonTree(jsonObj);
