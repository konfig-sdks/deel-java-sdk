 ...
 */
@ApiModel(description = "Worker's job title. You can enter a custom job title or use a pre-defiled job title using the Id retrieved in job-titles endpoint.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ContractToCreateSharedJobTitle {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Job title. Please leave it blank when entering an Id.")
   ...
   * @return the ContractToCreateSharedJobTitle instance itself
   */
  public ContractToCreateSharedJobTitle putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, contractToCreateSharedJobTitle.id) &&
        ...
        Objects.equals(this.additionalProperties, contractToCreateSharedJobTitle.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContractToCreateSharedJobTitle
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContractToCreateSharedJobTitle.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContractToCreateSharedJobTitle>() {
           ...
           public ContractToCreateSharedJobTitle read(JsonReader in) throws IOException {
             ...
             ContractToCreateSharedJobTitle instance = thisAdapter.fromJsonTree(jsonObj);
