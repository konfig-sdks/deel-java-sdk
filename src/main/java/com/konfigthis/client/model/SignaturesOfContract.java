...
public class SignaturesOfContract {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "normally name of client is used as signature")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Signatures of client representative.")
  ...
  **/
   ...
   * @return the SignaturesOfContract instance itself
   */
  public SignaturesOfContract putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientSignature, signaturesOfContract.clientSignature) &&
        ...
        Objects.equals(this.additionalProperties, signaturesOfContract.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientSignature, clientSignedAt, workerSignature, workerSignedAt, signedAt, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SignaturesOfContract
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SignaturesOfContract.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SignaturesOfContract>() {
           ...
           public SignaturesOfContract read(JsonReader in) throws IOException {
             ...
             SignaturesOfContract instance = thisAdapter.fromJsonTree(jsonObj);
