...
public class EORContractBenefitsInnerProvider {
  ...
  **/
  ...
  @ApiModelProperty(example = "Provider name", value = "Name of the provider.")
   ...
   * @return the EORContractBenefitsInnerProvider instance itself
   */
  public EORContractBenefitsInnerProvider putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, eoRContractBenefitsInnerProvider.name)&&
        Objects.equals(this.additionalProperties, eoRContractBenefitsInnerProvider.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EORContractBenefitsInnerProvider
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EORContractBenefitsInnerProvider.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EORContractBenefitsInnerProvider>() {
           ...
           public EORContractBenefitsInnerProvider read(JsonReader in) throws IOException {
             ...
             EORContractBenefitsInnerProvider instance = thisAdapter.fromJsonTree(jsonObj);
