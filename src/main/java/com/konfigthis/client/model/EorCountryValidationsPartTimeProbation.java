 ...
 */
@ApiModel(description = "Probation period range for part-time contracts.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class EorCountryValidationsPartTimeProbation {
  ...
  public EorCountryValidationsPartTimeProbation min(Double min) {
  ...
  public EorCountryValidationsPartTimeProbation min(Integer min) {
  ...
  **/
  ...
  @ApiModelProperty(example = "30", value = "Minimum probation days required for a legally compliant contract.")
  ...
  public EorCountryValidationsPartTimeProbation max(Double max) {
  ...
  public EorCountryValidationsPartTimeProbation max(Integer max) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "60", value = "Maximum probation days allowed for a legally compliant contract.")
   ...
   * @return the EorCountryValidationsPartTimeProbation instance itself
   */
  public EorCountryValidationsPartTimeProbation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.min, eorCountryValidationsPartTimeProbation.min) &&
        ...
        Objects.equals(this.additionalProperties, eorCountryValidationsPartTimeProbation.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EorCountryValidationsPartTimeProbation
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EorCountryValidationsPartTimeProbation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EorCountryValidationsPartTimeProbation>() {
           ...
           public EorCountryValidationsPartTimeProbation read(JsonReader in) throws IOException {
             ...
             EorCountryValidationsPartTimeProbation instance = thisAdapter.fromJsonTree(jsonObj);
