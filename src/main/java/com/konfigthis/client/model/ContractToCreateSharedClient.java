...
public class ContractToCreateSharedClient {
  ...
  **/
   ...
   * @return the ContractToCreateSharedClient instance itself
   */
  public ContractToCreateSharedClient putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.legalEntity, contractToCreateSharedClient.legalEntity) &&
        ...
        Objects.equals(this.additionalProperties, contractToCreateSharedClient.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContractToCreateSharedClient
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContractToCreateSharedClient.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      ContractToCreateSharedClientLegalEntity.validateJsonObject(jsonObj.getAsJsonObject("legal_entity"));
      // validate the required field `team`
      ContractToCreateSharedClientTeam.validateJsonObject(jsonObj.getAsJsonObject("team"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContractToCreateSharedClient>() {
           ...
           public ContractToCreateSharedClient read(JsonReader in) throws IOException {
             ...
             ContractToCreateSharedClient instance = thisAdapter.fromJsonTree(jsonObj);
