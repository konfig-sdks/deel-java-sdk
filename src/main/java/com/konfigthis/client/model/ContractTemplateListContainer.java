...
import com.konfigthis.client.model.ContractTemplateSummary;
...
public class ContractTemplateListContainer {
  ...
  private List<ContractTemplateSummary> data = null;
  ...
  **/
   ...
   * @return the ContractTemplateListContainer instance itself
   */
  public ContractTemplateListContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, contractTemplateListContainer.data)&&
        Objects.equals(this.additionalProperties, contractTemplateListContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContractTemplateListContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContractTemplateListContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ContractTemplateSummary.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContractTemplateListContainer>() {
           ...
           public ContractTemplateListContainer read(JsonReader in) throws IOException {
             ...
             ContractTemplateListContainer instance = thisAdapter.fromJsonTree(jsonObj);
