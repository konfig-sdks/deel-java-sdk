...
import com.konfigthis.client.model.HealthInsuranceProvider;
...
public class EorCountryValidationsHealthInsurance {
  ...
  private List<HealthInsuranceProvider> providers = null;
  ...
  **/
   ...
   * @return the EorCountryValidationsHealthInsurance instance itself
   */
  public EorCountryValidationsHealthInsurance putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, eorCountryValidationsHealthInsurance.status) &&
        ...
        Objects.equals(this.additionalProperties, eorCountryValidationsHealthInsurance.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EorCountryValidationsHealthInsurance
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EorCountryValidationsHealthInsurance.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("providers") != null && !jsonObj.get("providers").isJsonNull()) {
        ...
        if (jsonArrayproviders != null) {
          ...
          for (int i = 0; i < jsonArrayproviders.size(); i++) {
            HealthInsuranceProvider.validateJsonObject(jsonArrayproviders.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EorCountryValidationsHealthInsurance>() {
           ...
           public EorCountryValidationsHealthInsurance read(JsonReader in) throws IOException {
             ...
             EorCountryValidationsHealthInsurance instance = thisAdapter.fromJsonTree(jsonObj);
