 ...
 */
@ApiModel(description = "This object is used for linking file attachments to your records.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FileAttachmentInfo {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Original filename you used to upload using attachments end-point.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "You can call attachments end-point, get key and URL to upload your file.")
   ...
   * @return the FileAttachmentInfo instance itself
   */
  public FileAttachmentInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filename, fileAttachmentInfo.filename) &&
        ...
        Objects.equals(this.additionalProperties, fileAttachmentInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filename, key, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileAttachmentInfo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileAttachmentInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FileAttachmentInfo>() {
           ...
           public FileAttachmentInfo read(JsonReader in) throws IOException {
             ...
             FileAttachmentInfo instance = thisAdapter.fromJsonTree(jsonObj);
