...
public class GenericReportReviewCreated {
  ...
  **/
   ...
   * @return the GenericReportReviewCreated instance itself
   */
  public GenericReportReviewCreated putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, genericReportReviewCreated.status) &&
        ...
        Objects.equals(this.additionalProperties, genericReportReviewCreated.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, id, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenericReportReviewCreated
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GenericReportReviewCreated.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GenericReportReviewCreated>() {
           ...
           public GenericReportReviewCreated read(JsonReader in) throws IOException {
             ...
             GenericReportReviewCreated instance = thisAdapter.fromJsonTree(jsonObj);
