...
public class CostQuote {
  ...
  **/
  ...
  @ApiModelProperty(value = "Cost's name")
  ...
  **/
  ...
  public CostQuote total(Double total) {
  ...
  public CostQuote total(Integer total) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total cost in local currency")
  ...
  public CostQuote totalUsd(Double totalUsd) {
  ...
  public CostQuote totalUsd(Integer totalUsd) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total cost in USD")
   ...
   * @return the CostQuote instance itself
   */
  public CostQuote putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, costQuote.name) &&
        ...
        Objects.equals(this.additionalProperties, costQuote.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, currency, total, totalUsd, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CostQuote
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CostQuote.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CostQuote>() {
           ...
           public CostQuote read(JsonReader in) throws IOException {
             ...
             CostQuote instance = thisAdapter.fromJsonTree(jsonObj);
