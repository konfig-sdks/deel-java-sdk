...
public class CompensationDetailsOfContract {
  ...
  **/
   ...
   * @return the CompensationDetailsOfContract instance itself
   */
  public CompensationDetailsOfContract putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currencyCode, compensationDetailsOfContract.currencyCode) &&
        ...
        Objects.equals(this.additionalProperties, compensationDetailsOfContract.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currencyCode, amount, scale, frequency, firstPayment, firstPaymentDate, grossAnnualSalary, grossSigningBonus, grossVariableBonus, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CompensationDetailsOfContract
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CompensationDetailsOfContract.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CompensationDetailsOfContract>() {
           ...
           public CompensationDetailsOfContract read(JsonReader in) throws IOException {
             ...
             CompensationDetailsOfContract instance = thisAdapter.fromJsonTree(jsonObj);
