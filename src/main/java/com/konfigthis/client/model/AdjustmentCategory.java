...
public class AdjustmentCategory {
  ...
  **/
  ...
  @ApiModelProperty(example = "c0431543f64c448e5ba4b525a50291", value = "Unique identifier of an adjustment category.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "currency", value = "The unit type of the adjustment category.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Employee Dinner", value = "The label of the adjustment category.")
   ...
   * @return the AdjustmentCategory instance itself
   */
  public AdjustmentCategory putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, adjustmentCategory.id) &&
        ...
        Objects.equals(this.additionalProperties, adjustmentCategory.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, unitType, label, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AdjustmentCategory
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AdjustmentCategory.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AdjustmentCategory>() {
           ...
           public AdjustmentCategory read(JsonReader in) throws IOException {
             ...
             AdjustmentCategory instance = thisAdapter.fromJsonTree(jsonObj);
