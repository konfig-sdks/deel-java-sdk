 ...
 */
@ApiModel(description = "Details of invoice adjustment created.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class InvoiceAdjustmentCreated {
  ...
  **/
   ...
   * @return the InvoiceAdjustmentCreated instance itself
   */
  public InvoiceAdjustmentCreated putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.created, invoiceAdjustmentCreated.created) &&
        ...
        Objects.equals(this.additionalProperties, invoiceAdjustmentCreated.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(created, id, status, createdAt, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceAdjustmentCreated
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceAdjustmentCreated.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InvoiceAdjustmentCreated>() {
           ...
           public InvoiceAdjustmentCreated read(JsonReader in) throws IOException {
             ...
             InvoiceAdjustmentCreated instance = thisAdapter.fromJsonTree(jsonObj);
