...
public class LetterRequest {
  ...
  **/
   ...
   * @return the LetterRequest instance itself
   */
  public LetterRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, letterRequest.description) &&
        ...
        Objects.equals(this.additionalProperties, letterRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, includeQRCode, type, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LetterRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LetterRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LetterRequest>() {
           ...
           public LetterRequest read(JsonReader in) throws IOException {
             ...
             LetterRequest instance = thisAdapter.fromJsonTree(jsonObj);
