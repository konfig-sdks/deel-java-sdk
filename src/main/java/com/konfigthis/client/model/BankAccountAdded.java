...
import com.konfigthis.client.model.BankAccountStatus;
...
public class BankAccountAdded {
  ...
  **/
  ...
  @ApiModelProperty(example = "dcc7b587-2246-4909-853e-12056e90c451", value = "ID of Bank Account.")
  ...
  **/
   ...
   * @return the BankAccountAdded instance itself
   */
  public BankAccountAdded putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, bankAccountAdded.id) &&
        ...
        Objects.equals(this.additionalProperties, bankAccountAdded.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, status, createdAt, updatedAt, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BankAccountAdded
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BankAccountAdded.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BankAccountAdded>() {
           ...
           public BankAccountAdded read(JsonReader in) throws IOException {
             ...
             BankAccountAdded instance = thisAdapter.fromJsonTree(jsonObj);
