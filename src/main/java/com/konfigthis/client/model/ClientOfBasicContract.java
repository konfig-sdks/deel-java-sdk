...
public class ClientOfBasicContract {
  ...
  **/
   ...
   * @return the ClientOfBasicContract instance itself
   */
  public ClientOfBasicContract putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.team, clientOfBasicContract.team)&&
        Objects.equals(this.additionalProperties, clientOfBasicContract.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ClientOfBasicContract
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ClientOfBasicContract.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("team") != null && !jsonObj.get("team").isJsonNull()) {
        TeamOfBasicContract.validateJsonObject(jsonObj.getAsJsonObject("team"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ClientOfBasicContract>() {
           ...
           public ClientOfBasicContract read(JsonReader in) throws IOException {
             ...
             ClientOfBasicContract instance = thisAdapter.fromJsonTree(jsonObj);
