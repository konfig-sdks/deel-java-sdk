...
public class InvoiceAdjustmentToCreateContainer {
  ...
  **/
   ...
   * @return the InvoiceAdjustmentToCreateContainer instance itself
   */
  public InvoiceAdjustmentToCreateContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, invoiceAdjustmentToCreateContainer.data)&&
        Objects.equals(this.additionalProperties, invoiceAdjustmentToCreateContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceAdjustmentToCreateContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceAdjustmentToCreateContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      InvoiceAdjustmentToCreate.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InvoiceAdjustmentToCreateContainer>() {
           ...
           public InvoiceAdjustmentToCreateContainer read(JsonReader in) throws IOException {
             ...
             InvoiceAdjustmentToCreateContainer instance = thisAdapter.fromJsonTree(jsonObj);
