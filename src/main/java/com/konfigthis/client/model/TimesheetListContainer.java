...
import com.konfigthis.client.model.BasicTimesheet;
import com.konfigthis.client.model.PageInfoWithoutCursor;
...
public class TimesheetListContainer {
  ...
  **/
   ...
   * @return the TimesheetListContainer instance itself
   */
  public TimesheetListContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, timesheetListContainer.data) &&
        ...
        Objects.equals(this.additionalProperties, timesheetListContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetListContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetListContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        BasicTimesheet.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
      // validate the required field `page`
      PageInfoWithoutCursor.validateJsonObject(jsonObj.getAsJsonObject("page"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TimesheetListContainer>() {
           ...
           public TimesheetListContainer read(JsonReader in) throws IOException {
             ...
             TimesheetListContainer instance = thisAdapter.fromJsonTree(jsonObj);
