...
import com.konfigthis.client.model.FileRefTypeEnum;
...
public class InputToCreateFileRefData {
  ...
  **/
   ...
   * @return the InputToCreateFileRefData instance itself
   */
  public InputToCreateFileRefData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contentType, inputToCreateFileRefData.contentType)&&
        Objects.equals(this.additionalProperties, inputToCreateFileRefData.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InputToCreateFileRefData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InputToCreateFileRefData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InputToCreateFileRefData>() {
           ...
           public InputToCreateFileRefData read(JsonReader in) throws IOException {
             ...
             InputToCreateFileRefData instance = thisAdapter.fromJsonTree(jsonObj);
