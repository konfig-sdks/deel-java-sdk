...
public class ExchangeRates {
  ...
  public ExchangeRates risk(Double risk) {
  ...
  public ExchangeRates risk(Integer risk) {
    
    
    
    
    this.risk = risk.doubleValue();
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "{\"USD\":1}", value = "")
   ...
   * @return the ExchangeRates instance itself
   */
  public ExchangeRates putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.risk, exchangeRates.risk) &&
        ...
        Objects.equals(this.additionalProperties, exchangeRates.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(risk, rates, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ExchangeRates
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExchangeRates.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ExchangeRates>() {
           ...
           public ExchangeRates read(JsonReader in) throws IOException {
             ...
             ExchangeRates instance = thisAdapter.fromJsonTree(jsonObj);
