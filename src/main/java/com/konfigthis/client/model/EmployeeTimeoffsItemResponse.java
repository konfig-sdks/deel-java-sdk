...
import com.konfigthis.client.model.EmployeeTimeoffsItemResponseAttachmentsInner;
import com.konfigthis.client.model.RequesterTimeOff;
...
public class EmployeeTimeoffsItemResponse {
 ...
 public enum TypeEnum {
  ...
  private List<EmployeeTimeoffsItemResponseAttachmentsInner> attachments = null;
  ...
  private List<Object> appliedChanges = null;
  ...
  **/
  ...
  @ApiModelProperty(example = "bca1738c-194a-48e7-a26d-89fddca5bff3", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "e0a91fd6-0646-41ae-84a9-ca3d2f761793", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "85cae186-c0b2-4b92-b554-d8eb1f0fdc1d", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Vacation - unlimited days", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "I need to relax.", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "VACATION", value = "Time off type.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2023-08-03T22:00:00.000Z", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0.50", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0.00", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2024-02-23T23:00:00.000Z", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2024-02-25T23:00:00.000Z", value = "")
  ...
  **/
   ...
   * @return the EmployeeTimeoffsItemResponse instance itself
   */
  public EmployeeTimeoffsItemResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.timeOffId, employeeTimeoffsItemResponse.timeOffId) &&
        ...
        Objects.equals(this.additionalProperties, employeeTimeoffsItemResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timeOffId, timeOffTypeId, policyId, policyName, policyTypeName, reason, type, requestedAt, reviewedAt, withMultipleDates, singleDate, createdAt, updatedAt, denialReason, requester, daysUsedStartYear, daysUsedEndYear, daysUsed, startDate, endDate, isStartDateHalfDay, isEndDateHalfDay, attachments, changeRequest, isUpdated, appliedChanges, canRequestChanges, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeTimeoffsItemResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeTimeoffsItemResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("requester") != null && !jsonObj.get("requester").isJsonNull()) {
        RequesterTimeOff.validateJsonObject(jsonObj.getAsJsonObject("requester"));
      }
      ...
      if (jsonObj.get("attachments") != null && !jsonObj.get("attachments").isJsonNull()) {
        ...
        if (jsonArrayattachments != null) {
          ...
          for (int i = 0; i < jsonArrayattachments.size(); i++) {
            EmployeeTimeoffsItemResponseAttachmentsInner.validateJsonObject(jsonArrayattachments.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("applied_changes") != null && !jsonObj.get("applied_changes").isJsonArray()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EmployeeTimeoffsItemResponse>() {
           ...
           public EmployeeTimeoffsItemResponse read(JsonReader in) throws IOException {
             ...
             EmployeeTimeoffsItemResponse instance = thisAdapter.fromJsonTree(jsonObj);
