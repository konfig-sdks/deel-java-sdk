...
import com.konfigthis.client.model.EorEntitlements;
...
public class EorEntitlementsContainer {
  ...
  **/
   ...
   * @return the EorEntitlementsContainer instance itself
   */
  public EorEntitlementsContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, eorEntitlementsContainer.data)&&
        Objects.equals(this.additionalProperties, eorEntitlementsContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EorEntitlementsContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EorEntitlementsContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      EorEntitlements.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EorEntitlementsContainer>() {
           ...
           public EorEntitlementsContainer read(JsonReader in) throws IOException {
             ...
             EorEntitlementsContainer instance = thisAdapter.fromJsonTree(jsonObj);
