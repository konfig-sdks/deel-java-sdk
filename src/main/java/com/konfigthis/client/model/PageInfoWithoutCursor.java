...
public class PageInfoWithoutCursor {
  ...
  public PageInfoWithoutCursor totalRows(Double totalRows) {
  ...
  public PageInfoWithoutCursor totalRows(Integer totalRows) {
  ...
  **/
   ...
   * @return the PageInfoWithoutCursor instance itself
   */
  public PageInfoWithoutCursor putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalRows, pageInfoWithoutCursor.totalRows)&&
        Objects.equals(this.additionalProperties, pageInfoWithoutCursor.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(totalRows, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PageInfoWithoutCursor
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PageInfoWithoutCursor.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PageInfoWithoutCursor>() {
           ...
           public PageInfoWithoutCursor read(JsonReader in) throws IOException {
             ...
             PageInfoWithoutCursor instance = thisAdapter.fromJsonTree(jsonObj);
