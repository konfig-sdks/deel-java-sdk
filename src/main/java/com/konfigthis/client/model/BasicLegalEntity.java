...
public class BasicLegalEntity {
  ...
  **/
   ...
   * @return the BasicLegalEntity instance itself
   */
  public BasicLegalEntity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, basicLegalEntity.id) &&
        ...
        Objects.equals(this.additionalProperties, basicLegalEntity.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, country, entityType, entitySubtype, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BasicLegalEntity
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BasicLegalEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BasicLegalEntity>() {
           ...
           public BasicLegalEntity read(JsonReader in) throws IOException {
             ...
             BasicLegalEntity instance = thisAdapter.fromJsonTree(jsonObj);
