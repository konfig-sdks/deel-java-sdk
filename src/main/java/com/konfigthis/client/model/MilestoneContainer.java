...
public class MilestoneContainer {
  ...
  **/
   ...
   * @return the MilestoneContainer instance itself
   */
  public MilestoneContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, milestoneContainer.data)&&
        Objects.equals(this.additionalProperties, milestoneContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MilestoneContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MilestoneContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      Milestone.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MilestoneContainer>() {
           ...
           public MilestoneContainer read(JsonReader in) throws IOException {
             ...
             MilestoneContainer instance = thisAdapter.fromJsonTree(jsonObj);
