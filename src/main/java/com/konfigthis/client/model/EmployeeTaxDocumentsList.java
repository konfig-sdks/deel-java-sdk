...
public class EmployeeTaxDocumentsList {
  ...
  public EmployeeTaxDocumentsList year(Double year) {
  ...
  public EmployeeTaxDocumentsList year(Integer year) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Tax Document", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "9AmobdjMwXOq", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://example.com/file.pdf", value = "")
   ...
   * @return the EmployeeTaxDocumentsList instance itself
   */
  public EmployeeTaxDocumentsList putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.year, employeeTaxDocumentsList.year) &&
        ...
        Objects.equals(this.additionalProperties, employeeTaxDocumentsList.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(year, type, country, id, url, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeTaxDocumentsList
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeTaxDocumentsList.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EmployeeTaxDocumentsList>() {
           ...
           public EmployeeTaxDocumentsList read(JsonReader in) throws IOException {
             ...
             EmployeeTaxDocumentsList instance = thisAdapter.fromJsonTree(jsonObj);
