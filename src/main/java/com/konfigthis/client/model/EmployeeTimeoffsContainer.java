...
import com.konfigthis.client.model.EmployeeTimeoffsItem;
...
public class EmployeeTimeoffsContainer {
  ...
  private List<EmployeeTimeoffsItem> data = null;
  ...
  **/
  ...
  @ApiModelProperty(value = "List of employee time offs.")
   ...
   * @return the EmployeeTimeoffsContainer instance itself
   */
  public EmployeeTimeoffsContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, employeeTimeoffsContainer.data)&&
        Objects.equals(this.additionalProperties, employeeTimeoffsContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeTimeoffsContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeTimeoffsContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            EmployeeTimeoffsItem.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EmployeeTimeoffsContainer>() {
           ...
           public EmployeeTimeoffsContainer read(JsonReader in) throws IOException {
             ...
             EmployeeTimeoffsContainer instance = thisAdapter.fromJsonTree(jsonObj);
