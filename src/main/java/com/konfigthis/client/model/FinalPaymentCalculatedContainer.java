...
import com.konfigthis.client.model.FinalPaymentCalculated;
...
public class FinalPaymentCalculatedContainer {
  ...
  **/
   ...
   * @return the FinalPaymentCalculatedContainer instance itself
   */
  public FinalPaymentCalculatedContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, finalPaymentCalculatedContainer.data)&&
        Objects.equals(this.additionalProperties, finalPaymentCalculatedContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FinalPaymentCalculatedContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FinalPaymentCalculatedContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      FinalPaymentCalculated.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FinalPaymentCalculatedContainer>() {
           ...
           public FinalPaymentCalculatedContainer read(JsonReader in) throws IOException {
             ...
             FinalPaymentCalculatedContainer instance = thisAdapter.fromJsonTree(jsonObj);
