 ...
 */
@ApiModel(description = "Customized attributes on contracts (Employee ID, Project code, etc).")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ContractCustomField {
  ...
  **/
  ...
  @ApiModelProperty(example = "Employee ID", value = "Custom field property name.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "54234", value = "Custom field property value.")
   ...
   * @return the ContractCustomField instance itself
   */
  public ContractCustomField putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, contractCustomField.name) &&
        ...
        Objects.equals(this.additionalProperties, contractCustomField.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContractCustomField
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContractCustomField.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContractCustomField>() {
           ...
           public ContractCustomField read(JsonReader in) throws IOException {
             ...
             ContractCustomField instance = thisAdapter.fromJsonTree(jsonObj);
