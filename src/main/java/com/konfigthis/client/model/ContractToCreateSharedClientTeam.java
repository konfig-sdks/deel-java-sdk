 ...
 */
@ApiModel(description = "Choose the Deel team for this contract. Use teams endpoint to retrieve a list of teams in your organization.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ContractToCreateSharedClientTeam {
  ...
  public ContractToCreateSharedClientTeam id(String id) {
  ...
  **/
   ...
   * @return the ContractToCreateSharedClientTeam instance itself
   */
  public ContractToCreateSharedClientTeam putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, contractToCreateSharedClientTeam.id)&&
        Objects.equals(this.additionalProperties, contractToCreateSharedClientTeam.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContractToCreateSharedClientTeam
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContractToCreateSharedClientTeam.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContractToCreateSharedClientTeam>() {
           ...
           public ContractToCreateSharedClientTeam read(JsonReader in) throws IOException {
             ...
             ContractToCreateSharedClientTeam instance = thisAdapter.fromJsonTree(jsonObj);
