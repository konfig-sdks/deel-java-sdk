...
public class HrisDirectEmployeeResponse {
  ...
  private Object jobInformation = null;
  ...
  **/
  ...
  public HrisDirectEmployeeResponse jobInformation(Object jobInformation) {
  ...
  **/
  ...
  public HrisDirectEmployeeResponse contract(Object contract) {
  ...
  **/
   ...
   * @return the HrisDirectEmployeeResponse instance itself
   */
  public HrisDirectEmployeeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.employeeDetails, hrisDirectEmployeeResponse.employeeDetails) &&
        ...
        Objects.equals(this.additionalProperties, hrisDirectEmployeeResponse.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(employeeDetails, teamInformation, jobInformation, compensation, contract, vacationInfo, id, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to HrisDirectEmployeeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HrisDirectEmployeeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      HrisDirectEmployeeDetails.validateJsonObject(jsonObj.getAsJsonObject("employee_details"));
      // validate the required field `team_information`
      HrisTeamInformation.validateJsonObject(jsonObj.getAsJsonObject("team_information"));
      // validate the required field `compensation`
      HrisCompensation.validateJsonObject(jsonObj.getAsJsonObject("compensation"));
      // validate the optional field `vacation_info`
      if (jsonObj.get("vacation_info") != null && !jsonObj.get("vacation_info").isJsonNull()) {
        HrisDirectEmployeeVacationInfo.validateJsonObject(jsonObj.getAsJsonObject("vacation_info"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<HrisDirectEmployeeResponse>() {
           ...
           public HrisDirectEmployeeResponse read(JsonReader in) throws IOException {
             ...
             HrisDirectEmployeeResponse instance = thisAdapter.fromJsonTree(jsonObj);
