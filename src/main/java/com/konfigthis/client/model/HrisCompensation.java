...
public class HrisCompensation {
  ...
  **/
   ...
   * @return the HrisCompensation instance itself
   */
  public HrisCompensation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.grossAnnualSalary, hrisCompensation.grossAnnualSalary) &&
        ...
        Objects.equals(this.additionalProperties, hrisCompensation.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(grossAnnualSalary, currency, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to HrisCompensation
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HrisCompensation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<HrisCompensation>() {
           ...
           public HrisCompensation read(JsonReader in) throws IOException {
             ...
             HrisCompensation instance = thisAdapter.fromJsonTree(jsonObj);
