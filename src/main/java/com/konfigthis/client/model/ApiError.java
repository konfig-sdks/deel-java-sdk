...
public class ApiError {
  ...
  **/
  ...
  @ApiModelProperty(example = "Must have required property 'example_field'", value = "A description of the returned error")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "/data/type", value = "The JSON path where input validation failed")
