 ...
 */
@ApiModel(description = "Seniority describes level of expertise at a job e.g. junior")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SeniorityRequired {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Mid (Individual Contributor Level 2)", required = true, value = "Name of seniority level e.g. Mid (Individual Contributor Level 2)")
  ...
  public SeniorityRequired level(Double level) {
  ...
  public SeniorityRequired level(Integer level) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2", required = true, value = "Level of seniority level e.g. 2")
   ...
   * @return the SeniorityRequired instance itself
   */
  public SeniorityRequired putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, seniorityRequired.id) &&
        ...
        Objects.equals(this.additionalProperties, seniorityRequired.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, level, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SeniorityRequired
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SeniorityRequired.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SeniorityRequired>() {
           ...
           public SeniorityRequired read(JsonReader in) throws IOException {
             ...
             SeniorityRequired instance = thisAdapter.fromJsonTree(jsonObj);
