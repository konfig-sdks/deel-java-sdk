 ...
 */
@ApiModel(description = "The last payment cycle.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FinalPaymentCalculatedLastCycle {
  ...
  **/
   ...
   * @return the FinalPaymentCalculatedLastCycle instance itself
   */
  public FinalPaymentCalculatedLastCycle putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.start, finalPaymentCalculatedLastCycle.start) &&
        ...
        Objects.equals(this.additionalProperties, finalPaymentCalculatedLastCycle.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(start, end, completionDate, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FinalPaymentCalculatedLastCycle
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FinalPaymentCalculatedLastCycle.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FinalPaymentCalculatedLastCycle>() {
           ...
           public FinalPaymentCalculatedLastCycle read(JsonReader in) throws IOException {
             ...
             FinalPaymentCalculatedLastCycle instance = thisAdapter.fromJsonTree(jsonObj);
