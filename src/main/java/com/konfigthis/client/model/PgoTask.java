...
public class PgoTask {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "200", required = true, value = "Fixed rate for this task.")
  ...
  **/
   ...
   * @return the PgoTask instance itself
   */
  public PgoTask putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, pgoTask.description) &&
        Objects.equals(this.id, pgoTask.id) &&
        ...
        Objects.equals(this.additionalProperties, pgoTask.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, id, amount, dateSubmitted, status, attachment, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PgoTask
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PgoTask.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PgoTask>() {
           ...
           public PgoTask read(JsonReader in) throws IOException {
             ...
             PgoTask instance = thisAdapter.fromJsonTree(jsonObj);
