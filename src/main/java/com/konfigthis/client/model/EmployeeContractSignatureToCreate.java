...
public class EmployeeContractSignatureToCreate {
  ...
  public EmployeeContractSignatureToCreate signature(String signature) {
    ...
    if (signature != null && signature.length() < 2) {
      throw new IllegalArgumentException("Invalid value for signature. Length must be greater than or equal to 2.");
    }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Signature of employee.")
   ...
   * @return the EmployeeContractSignatureToCreate instance itself
   */
  public EmployeeContractSignatureToCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.signature, employeeContractSignatureToCreate.signature)&&
        Objects.equals(this.additionalProperties, employeeContractSignatureToCreate.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeContractSignatureToCreate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeContractSignatureToCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EmployeeContractSignatureToCreate>() {
           ...
           public EmployeeContractSignatureToCreate read(JsonReader in) throws IOException {
             ...
             EmployeeContractSignatureToCreate instance = thisAdapter.fromJsonTree(jsonObj);
