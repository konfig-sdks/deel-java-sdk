...
public class PaymentBreakDown {
  ...
  **/
  ...
  @ApiModelProperty(example = "2022-10-01T00:59:28.482Z", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Deel Inc.", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "12345", value = "Worker's unique identifier.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Jane Doe", value = "Worker's name.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "name@email.com", value = "Worker's email.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "5069872", value = "Invoice number.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "5551621", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1000.00", value = "Total due.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1000.00", value = "Total in payment currency.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2022-11-01T17:20:32.837Z", value = "Date of payment.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "US", value = "Country of the contract.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2020-03-31T10:58:49.780Z", value = "Contract start date.")
  ...
  **/
   ...
   * @return the PaymentBreakDown instance itself
   */
  public PaymentBreakDown putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.date, paymentBreakDown.date) &&
        ...
        Objects.equals(this.additionalProperties, paymentBreakDown.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(date, generalLedgerAccount, team, contractorUniqueIdentifier, contractorEmployeeName, contractorEmail, invoiceNumber, currency, paymentCurrency, receiptNumber, work, bonus, expenses, commissions, deductions, overtime, proRata, others, processingFee, adjustment, total, totalPaymentCurrency, paymentDate, frequency, contractCountry, contractStartDate, approvers, approveDate, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentBreakDown
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentBreakDown.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PaymentBreakDown>() {
           ...
           public PaymentBreakDown read(JsonReader in) throws IOException {
             ...
             PaymentBreakDown instance = thisAdapter.fromJsonTree(jsonObj);
