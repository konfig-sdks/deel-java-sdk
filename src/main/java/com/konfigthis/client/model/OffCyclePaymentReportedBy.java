...
public class OffCyclePaymentReportedBy {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "John Smith", required = true, value = "Full name of the creator.")
   ...
   * @return the OffCyclePaymentReportedBy instance itself
   */
  public OffCyclePaymentReportedBy putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, offCyclePaymentReportedBy.id) &&
        ...
        Objects.equals(this.additionalProperties, offCyclePaymentReportedBy.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OffCyclePaymentReportedBy
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OffCyclePaymentReportedBy.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OffCyclePaymentReportedBy>() {
           ...
           public OffCyclePaymentReportedBy read(JsonReader in) throws IOException {
             ...
             OffCyclePaymentReportedBy instance = thisAdapter.fromJsonTree(jsonObj);
