 ...
 * Resource metadata.
 */
@ApiModel(description = "Resource metadata.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Meta {
 ...
 public enum ResourceTypeEnum {
  ...
  public Meta created(OffsetDateTime created) {
  ...
  **/
  ...
  public Meta lastModified(OffsetDateTime lastModified) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "resource location URI")
  ...
  public Meta resourceType(ResourceTypeEnum resourceType) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(created, lastModified, location, resourceType, additionalProperties);
  }
