...
public class InvoiceDownloadObject {
  ...
  **/
  ...
  @ApiModelProperty(example = "https://s3URL/letsdeel.com/invoices/12345.pdf", required = true, value = "URL to requested invoice to download.")
   ...
   * @return the InvoiceDownloadObject instance itself
   */
  public InvoiceDownloadObject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, invoiceDownloadObject.url)&&
        Objects.equals(this.additionalProperties, invoiceDownloadObject.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceDownloadObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceDownloadObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InvoiceDownloadObject>() {
           ...
           public InvoiceDownloadObject read(JsonReader in) throws IOException {
             ...
             InvoiceDownloadObject instance = thisAdapter.fromJsonTree(jsonObj);
