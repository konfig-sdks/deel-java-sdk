...
public class BasicTimesheet {
  ...
  **/
  ...
  public BasicTimesheet quantity(Double quantity) {
  ...
  public BasicTimesheet quantity(Integer quantity) {
  ...
  **/
   ...
   * @return the BasicTimesheet instance itself
   */
  public BasicTimesheet putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, basicTimesheet.description) &&
        Objects.equals(this.id, basicTimesheet.id) &&
        ...
        Objects.equals(this.additionalProperties, basicTimesheet.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, id, type, status, dateSubmitted, currencyCode, totalAmount, quantity, createdAt, scale, customScale, attachment, worksheet, reviewedBy, contract, paymentCycle, reportedBy, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BasicTimesheet
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BasicTimesheet.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BasicTimesheet>() {
           ...
           public BasicTimesheet read(JsonReader in) throws IOException {
             ...
             BasicTimesheet instance = thisAdapter.fromJsonTree(jsonObj);
