...
public class ContractToCreateContainerOngoingTimeBased {
  ...
  **/
   ...
   * @return the ContractToCreateContainerOngoingTimeBased instance itself
   */
  public ContractToCreateContainerOngoingTimeBased putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, contractToCreateContainerOngoingTimeBased.data)&&
        Objects.equals(this.additionalProperties, contractToCreateContainerOngoingTimeBased.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContractToCreateContainerOngoingTimeBased
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContractToCreateContainerOngoingTimeBased.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      ContractToCreateOngoingTimeBased.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContractToCreateContainerOngoingTimeBased>() {
           ...
           public ContractToCreateContainerOngoingTimeBased read(JsonReader in) throws IOException {
             ...
             ContractToCreateContainerOngoingTimeBased instance = thisAdapter.fromJsonTree(jsonObj);
