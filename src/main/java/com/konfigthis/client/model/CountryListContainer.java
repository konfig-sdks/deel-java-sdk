...
public class CountryListContainer {
  ...
  **/
   ...
   * @return the CountryListContainer instance itself
   */
  public CountryListContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, countryListContainer.data)&&
        Objects.equals(this.additionalProperties, countryListContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CountryListContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CountryListContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        Country.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CountryListContainer>() {
           ...
           public CountryListContainer read(JsonReader in) throws IOException {
             ...
             CountryListContainer instance = thisAdapter.fromJsonTree(jsonObj);
