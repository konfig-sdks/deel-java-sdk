 ...
 */
@ApiModel(description = "Some countries required a pension benefit.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PensionEORContractToCreate {
  ...
  **/
  ...
  @ApiModelProperty(value = "Pension provider id. You can see available pension providers in the country guide endpoint.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Enter the value of pension contribution. You should send this value only if the contribution object is available in the country guide endpoint and the value should be there between minimum and maximum values indicated.")
   ...
   * @return the PensionEORContractToCreate instance itself
   */
  public PensionEORContractToCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, pensionEORContractToCreate.id) &&
        ...
        Objects.equals(this.additionalProperties, pensionEORContractToCreate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, contribution, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PensionEORContractToCreate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PensionEORContractToCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PensionEORContractToCreate>() {
           ...
           public PensionEORContractToCreate read(JsonReader in) throws IOException {
             ...
             PensionEORContractToCreate instance = thisAdapter.fromJsonTree(jsonObj);
