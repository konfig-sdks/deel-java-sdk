...
public class InvoiceAdjustmentToCreateWithFile {
  ...
  **/
  ...
  public InvoiceAdjustmentToCreateWithFile amount(Double amount) {
  ...
  public InvoiceAdjustmentToCreateWithFile amount(Integer amount) {
    if (amount != null && amount < 0) {
      throw new IllegalArgumentException("Invalid value for amount. Must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public InvoiceAdjustmentToCreateWithFile paymentCycleId(Double paymentCycleId) {
  ...
  public InvoiceAdjustmentToCreateWithFile paymentCycleId(Integer paymentCycleId) {
  ...
  **/
   ...
   * @return the InvoiceAdjustmentToCreateWithFile instance itself
   */
  public InvoiceAdjustmentToCreateWithFile putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, invoiceAdjustmentToCreateWithFile.description) &&
        Objects.equals(this.contractId, invoiceAdjustmentToCreateWithFile.contractId) &&
        ...
        Objects.equals(this.additionalProperties, invoiceAdjustmentToCreateWithFile.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, contractId, dateSubmitted, type, amount, paymentCycleId, _file, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceAdjustmentToCreateWithFile
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceAdjustmentToCreateWithFile.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InvoiceAdjustmentToCreateWithFile>() {
           ...
           public InvoiceAdjustmentToCreateWithFile read(JsonReader in) throws IOException {
             ...
             InvoiceAdjustmentToCreateWithFile instance = thisAdapter.fromJsonTree(jsonObj);
