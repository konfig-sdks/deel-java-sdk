...
public class Payslips {
  ...
  **/
  ...
  @ApiModelProperty(example = "9K1rw5vwkZX2", required = true, value = "Unique identifier for the payslip.")
  ...
  public Payslips from(Object from) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2023-08-01T00:00:00.000Z", required = true, value = "Start date of the payslip.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2023-08-31T00:00:00.000Z", required = true, value = "End date of the payslip.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "PUBLISHED", required = true, value = "Status of the payslip.")
   ...
   * @return the Payslips instance itself
   */
  public Payslips putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, payslips.id) &&
        ...
        Objects.equals(this.additionalProperties, payslips.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, from, to, status, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Payslips
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Payslips.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Payslips>() {
           ...
           public Payslips read(JsonReader in) throws IOException {
             ...
             Payslips instance = thisAdapter.fromJsonTree(jsonObj);
