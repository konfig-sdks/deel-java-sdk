 ...
 */
@ApiModel(description = "Details of the timesheet to create. Both a client or a contractor may create a timesheet.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TimesheetSharedProperties {
  ...
  **/
  ...
  public TimesheetSharedProperties quantity(Double quantity) {
  ...
  public TimesheetSharedProperties quantity(Integer quantity) {
    if (quantity != null && quantity < 0.01) {
      throw new IllegalArgumentException("Invalid value for quantity. Must be greater than or equal to 0.01.");
    }
  ...
  **/
   ...
   * @return the TimesheetSharedProperties instance itself
   */
  public TimesheetSharedProperties putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, timesheetSharedProperties.description) &&
        Objects.equals(this.contractId, timesheetSharedProperties.contractId) &&
        ...
        Objects.equals(this.additionalProperties, timesheetSharedProperties.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, contractId, dateSubmitted, quantity, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetSharedProperties
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetSharedProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TimesheetSharedProperties>() {
           ...
           public TimesheetSharedProperties read(JsonReader in) throws IOException {
             ...
             TimesheetSharedProperties instance = thisAdapter.fromJsonTree(jsonObj);
