...
public class HrisDirectEmployeeVacationInfo {
  ...
  private Double vacationYearlyPolicy;
  ...
  **/
  ...
  public HrisDirectEmployeeVacationInfo vacationYearlyPolicy(Double vacationYearlyPolicy) {
    if (vacationYearlyPolicy != null && vacationYearlyPolicy < 1) {
      throw new IllegalArgumentException("Invalid value for vacationYearlyPolicy. Must be greater than or equal to 1.");
    }
    if (vacationYearlyPolicy != null && vacationYearlyPolicy > 365) {
      throw new IllegalArgumentException("Invalid value for vacationYearlyPolicy. Must be less than or equal to 365.");
    }
  ...
  public HrisDirectEmployeeVacationInfo vacationYearlyPolicy(Integer vacationYearlyPolicy) {
    if (vacationYearlyPolicy != null && vacationYearlyPolicy < 1) {
      throw new IllegalArgumentException("Invalid value for vacationYearlyPolicy. Must be greater than or equal to 1.");
    }
    if (vacationYearlyPolicy != null && vacationYearlyPolicy > 365) {
    ...
    this.vacationYearlyPolicy = vacationYearlyPolicy.doubleValue();
    return this;
  }
  ...
  **/
  ...
  public Double getVacationYearlyPolicy() {
    return vacationYearlyPolicy;
  }


  public void setVacationYearlyPolicy(Double vacationYearlyPolicy) {
    if (vacationYearlyPolicy != null && vacationYearlyPolicy < 1) {
      throw new IllegalArgumentException("Invalid value for vacationYearlyPolicy. Must be greater than or equal to 1.");
    }
    if (vacationYearlyPolicy != null && vacationYearlyPolicy > 365) {
   ...
   * @return the HrisDirectEmployeeVacationInfo instance itself
   */
  public HrisDirectEmployeeVacationInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.vacationAccrualStartDate, hrisDirectEmployeeVacationInfo.vacationAccrualStartDate) &&
        ...
        Objects.equals(this.additionalProperties, hrisDirectEmployeeVacationInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(vacationAccrualStartDate, vacationYearlyPolicy, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to HrisDirectEmployeeVacationInfo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HrisDirectEmployeeVacationInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<HrisDirectEmployeeVacationInfo>() {
           ...
           public HrisDirectEmployeeVacationInfo read(JsonReader in) throws IOException {
             ...
             HrisDirectEmployeeVacationInfo instance = thisAdapter.fromJsonTree(jsonObj);
