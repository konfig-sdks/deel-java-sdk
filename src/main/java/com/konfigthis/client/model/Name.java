...
public class Name {
  ...
  **/
  ...
  @ApiModelProperty(example = "Doe", required = true, value = "User's family name.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Jane", required = true, value = "User's given name. Also known as first name.")
