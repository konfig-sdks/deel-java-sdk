...
public class BankAccountGuide {
  ...
  **/
  ...
  @ApiModelProperty(example = "countryCode", required = true, value = "The key of the field.")
  ...
  **/
  ...
  @ApiModelProperty(example = "Country", value = "Label for this field.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "true", required = true, value = "Whether the field is required or not.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "text", value = "Type of the field")
   ...
   * @return the BankAccountGuide instance itself
   */
  public BankAccountGuide putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, bankAccountGuide.key) &&
        ...
        Objects.equals(this.additionalProperties, bankAccountGuide.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, label, required, valuesAllowed, validations, type, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BankAccountGuide
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BankAccountGuide.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("values_allowed") != null && !jsonObj.get("values_allowed").isJsonNull()) {
        ...
        if (jsonArrayvaluesAllowed != null) {
          ...
          for (int i = 0; i < jsonArrayvaluesAllowed.size(); i++) {
            BankAccountValueAllowed.validateJsonObject(jsonArrayvaluesAllowed.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("validations") != null && !jsonObj.get("validations").isJsonNull()) {
        ...
        if (jsonArrayvalidations != null) {
          ...
          for (int i = 0; i < jsonArrayvalidations.size(); i++) {
            ValidationType.validateJsonObject(jsonArrayvalidations.get(i).getAsJsonObject());
          };
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BankAccountGuide>() {
           ...
           public BankAccountGuide read(JsonReader in) throws IOException {
             ...
             BankAccountGuide instance = thisAdapter.fromJsonTree(jsonObj);
