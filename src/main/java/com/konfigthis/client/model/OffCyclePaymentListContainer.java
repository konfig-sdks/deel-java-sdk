...
import com.konfigthis.client.model.OffCyclePayment;
...
public class OffCyclePaymentListContainer {
  ...
  **/
   ...
   * @return the OffCyclePaymentListContainer instance itself
   */
  public OffCyclePaymentListContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, offCyclePaymentListContainer.data)&&
        Objects.equals(this.additionalProperties, offCyclePaymentListContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OffCyclePaymentListContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OffCyclePaymentListContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        OffCyclePayment.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OffCyclePaymentListContainer>() {
           ...
           public OffCyclePaymentListContainer read(JsonReader in) throws IOException {
             ...
             OffCyclePaymentListContainer instance = thisAdapter.fromJsonTree(jsonObj);
