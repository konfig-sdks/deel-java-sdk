 ...
 */
@ApiModel(description = "Monthly payment details for the user")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class MonthlyPayment {
  ...
  **/
  ...
  @ApiModelProperty(value = "The number of monthly payments")
   ...
   * @return the MonthlyPayment instance itself
   */
  public MonthlyPayment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, monthlyPayment.count)&&
        Objects.equals(this.additionalProperties, monthlyPayment.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MonthlyPayment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MonthlyPayment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MonthlyPayment>() {
           ...
           public MonthlyPayment read(JsonReader in) throws IOException {
             ...
             MonthlyPayment instance = thisAdapter.fromJsonTree(jsonObj);
