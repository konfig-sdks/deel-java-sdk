...
public class OffCyclePaymentToCreate {
  ...
  **/
  ...
  @ApiModelProperty(value = "Description of off-cycle payment.")
  ...
  **/
  ...
  public OffCyclePaymentToCreate amount(Double amount) {
  ...
  public OffCyclePaymentToCreate amount(Integer amount) {
    if (amount != null && amount < 0) {
      throw new IllegalArgumentException("Invalid value for amount. Must be greater than or equal to 0.");
    }
  ...
  **/
   ...
   * @return the OffCyclePaymentToCreate instance itself
   */
  public OffCyclePaymentToCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, offCyclePaymentToCreate.description) &&
        Objects.equals(this.dateSubmitted, offCyclePaymentToCreate.dateSubmitted) &&
        Objects.equals(this.amount, offCyclePaymentToCreate.amount)&&
        Objects.equals(this.additionalProperties, offCyclePaymentToCreate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, dateSubmitted, amount, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OffCyclePaymentToCreate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OffCyclePaymentToCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OffCyclePaymentToCreate>() {
           ...
           public OffCyclePaymentToCreate read(JsonReader in) throws IOException {
             ...
             OffCyclePaymentToCreate instance = thisAdapter.fromJsonTree(jsonObj);
