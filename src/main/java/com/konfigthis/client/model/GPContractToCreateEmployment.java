...
import com.konfigthis.client.model.GPContractStatusTypeEnum;
import com.konfigthis.client.model.GPContractToCreateEmploymentHolidays;
...
public class GPContractToCreateEmployment {
  ...
  **/
   ...
   * @return the GPContractToCreateEmployment instance itself
   */
  public GPContractToCreateEmployment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, gpContractToCreateEmployment.type) &&
        ...
        Objects.equals(this.additionalProperties, gpContractToCreateEmployment.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, startDate, holidays, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GPContractToCreateEmployment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GPContractToCreateEmployment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      GPContractToCreateEmploymentHolidays.validateJsonObject(jsonObj.getAsJsonObject("holidays"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GPContractToCreateEmployment>() {
           ...
           public GPContractToCreateEmployment read(JsonReader in) throws IOException {
             ...
             GPContractToCreateEmployment instance = thisAdapter.fromJsonTree(jsonObj);
