...
import com.konfigthis.client.model.ClientLegalEntity;
import com.konfigthis.client.model.TeamOfContract;
...
public class ClientOfContract {
  ...
  **/
   ...
   * @return the ClientOfContract instance itself
   */
  public ClientOfContract putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, clientOfContract.id) &&
        ...
        Objects.equals(this.additionalProperties, clientOfContract.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, fullName, email, team, legalEntity, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ClientOfContract
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ClientOfContract.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      TeamOfContract.validateJsonObject(jsonObj.getAsJsonObject("team"));
      // validate the required field `legal_entity`
      ClientLegalEntity.validateJsonObject(jsonObj.getAsJsonObject("legal_entity"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ClientOfContract>() {
           ...
           public ClientOfContract read(JsonReader in) throws IOException {
             ...
             ClientOfContract instance = thisAdapter.fromJsonTree(jsonObj);
