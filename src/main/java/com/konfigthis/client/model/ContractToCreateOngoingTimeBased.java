...
public class ContractToCreateOngoingTimeBased {
  ...
  **/
  ...
  public ContractToCreateOngoingTimeBased noticePeriod(Double noticePeriod) {
  ...
  public ContractToCreateOngoingTimeBased noticePeriod(Integer noticePeriod) {
    if (noticePeriod != null && noticePeriod < 0) {
      throw new IllegalArgumentException("Invalid value for noticePeriod. Must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public ContractToCreateOngoingTimeBased compensationDetails(CompensationDetailsOfContractToCreateShared compensationDetails) {
  ...
  **/
   ...
   * @return the ContractToCreateOngoingTimeBased instance itself
   */
  public ContractToCreateOngoingTimeBased putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, contractToCreateOngoingTimeBased.title) &&
        ...
        Objects.equals(this.additionalProperties, contractToCreateOngoingTimeBased.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContractToCreateOngoingTimeBased
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContractToCreateOngoingTimeBased.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContractToCreateOngoingTimeBased>() {
           ...
           public ContractToCreateOngoingTimeBased read(JsonReader in) throws IOException {
             ...
             ContractToCreateOngoingTimeBased instance = thisAdapter.fromJsonTree(jsonObj);
