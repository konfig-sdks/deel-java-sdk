...
public class EORContractBenefitsInnerEnrollmentDetails {
  ...
  private EORContractBenefitsInnerEnrollmentDetailsPlan plan;
  ...
  **/
  ...
  @ApiModelProperty(example = "Enrolled", value = "Status of the enrollment.")
  ...
  public EORContractBenefitsInnerEnrollmentDetails plan(EORContractBenefitsInnerEnrollmentDetailsPlan plan) {
  ...
  **/
  ...
  public EORContractBenefitsInnerEnrollmentDetailsPlan getPlan() {
    return plan;
  }


  public void setPlan(EORContractBenefitsInnerEnrollmentDetailsPlan plan) {
  ...
  **/
   ...
   * @return the EORContractBenefitsInnerEnrollmentDetails instance itself
   */
  public EORContractBenefitsInnerEnrollmentDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, eoRContractBenefitsInnerEnrollmentDetails.status) &&
        ...
        Objects.equals(this.additionalProperties, eoRContractBenefitsInnerEnrollmentDetails.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, plan, standard, current, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EORContractBenefitsInnerEnrollmentDetails
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EORContractBenefitsInnerEnrollmentDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("plan") != null && !jsonObj.get("plan").isJsonNull()) {
        EORContractBenefitsInnerEnrollmentDetailsPlan.validateJsonObject(jsonObj.getAsJsonObject("plan"));
      }
      // validate the optional field `standard`
      if (jsonObj.get("standard") != null && !jsonObj.get("standard").isJsonNull()) {
        EORContractBenefitsInnerEnrollmentDetailsStandard.validateJsonObject(jsonObj.getAsJsonObject("standard"));
      }
      // validate the optional field `current`
      if (jsonObj.get("current") != null && !jsonObj.get("current").isJsonNull()) {
        EORContractBenefitsInnerEnrollmentDetailsCurrent.validateJsonObject(jsonObj.getAsJsonObject("current"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EORContractBenefitsInnerEnrollmentDetails>() {
           ...
           public EORContractBenefitsInnerEnrollmentDetails read(JsonReader in) throws IOException {
             ...
             EORContractBenefitsInnerEnrollmentDetails instance = thisAdapter.fromJsonTree(jsonObj);
