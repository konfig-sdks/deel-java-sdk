...
public class GPClient {
  ...
  private EorContractToCreateClientTeam legalEntity;
  ...
  public GPClient legalEntity(EorContractToCreateClientTeam legalEntity) {
  ...
  **/
  ...
  public EorContractToCreateClientTeam getLegalEntity() {
    return legalEntity;
  }


  public void setLegalEntity(EorContractToCreateClientTeam legalEntity) {
  ...
  public GPClient team(EorContractToCreateClientTeam team) {
  ...
  **/
   ...
   * @return the GPClient instance itself
   */
  public GPClient putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.legalEntity, gpClient.legalEntity) &&
        ...
        Objects.equals(this.additionalProperties, gpClient.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(legalEntity, team, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GPClient
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GPClient.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      EorContractToCreateClientTeam.validateJsonObject(jsonObj.getAsJsonObject("legal_entity"));
      // validate the required field `team`
      EorContractToCreateClientTeam.validateJsonObject(jsonObj.getAsJsonObject("team"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GPClient>() {
           ...
           public GPClient read(JsonReader in) throws IOException {
             ...
             GPClient instance = thisAdapter.fromJsonTree(jsonObj);
