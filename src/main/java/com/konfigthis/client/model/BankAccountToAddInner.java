...
public class BankAccountToAddInner {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The key of the bank account properties.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The value for that key property.")
   ...
   * @return the BankAccountToAddInner instance itself
   */
  public BankAccountToAddInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, bankAccountToAddInner.key) &&
        ...
        Objects.equals(this.additionalProperties, bankAccountToAddInner.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BankAccountToAddInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BankAccountToAddInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BankAccountToAddInner>() {
           ...
           public BankAccountToAddInner read(JsonReader in) throws IOException {
             ...
             BankAccountToAddInner instance = thisAdapter.fromJsonTree(jsonObj);
