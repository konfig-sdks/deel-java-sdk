...
import com.konfigthis.client.model.GenericResultCreatedWithIdData;
...
public class GenericResultCreatedWithId {
  ...
  **/
   ...
   * @return the GenericResultCreatedWithId instance itself
   */
  public GenericResultCreatedWithId putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, genericResultCreatedWithId.data)&&
        Objects.equals(this.additionalProperties, genericResultCreatedWithId.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenericResultCreatedWithId
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GenericResultCreatedWithId.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      GenericResultCreatedWithIdData.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GenericResultCreatedWithId>() {
           ...
           public GenericResultCreatedWithId read(JsonReader in) throws IOException {
             ...
             GenericResultCreatedWithId instance = thisAdapter.fromJsonTree(jsonObj);
