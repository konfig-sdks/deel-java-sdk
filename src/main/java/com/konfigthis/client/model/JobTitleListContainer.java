...
import com.konfigthis.client.model.JobTitleListContainerPage;
...
public class JobTitleListContainer {
  ...
  private JobTitleListContainerPage page;
  ...
  **/
  ...
  public JobTitleListContainer page(JobTitleListContainerPage page) {
  ...
  **/
  ...
  public JobTitleListContainerPage getPage() {
    return page;
  }


  public void setPage(JobTitleListContainerPage page) {
   ...
   * @return the JobTitleListContainer instance itself
   */
  public JobTitleListContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, jobTitleListContainer.data) &&
        ...
        Objects.equals(this.additionalProperties, jobTitleListContainer.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, page, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to JobTitleListContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JobTitleListContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      JobTitleListContainerPage.validateJsonObject(jsonObj.getAsJsonObject("page"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<JobTitleListContainer>() {
           ...
           public JobTitleListContainer read(JsonReader in) throws IOException {
             ...
             JobTitleListContainer instance = thisAdapter.fromJsonTree(jsonObj);
