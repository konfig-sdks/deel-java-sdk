 ...
 */
@ApiModel(description = "Holiday type and range for part-time contracts.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class EorCountryValidationsPartTimeHoliday {
  ...
  **/
  ...
  @ApiModelProperty(example = "SPECIFIC", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "15", value = "Minimum number of holidays required for a legally compliant contract.")
   ...
   * @return the EorCountryValidationsPartTimeHoliday instance itself
   */
  public EorCountryValidationsPartTimeHoliday putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, eorCountryValidationsPartTimeHoliday.type) &&
        ...
        Objects.equals(this.additionalProperties, eorCountryValidationsPartTimeHoliday.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, min, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EorCountryValidationsPartTimeHoliday
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EorCountryValidationsPartTimeHoliday.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EorCountryValidationsPartTimeHoliday>() {
           ...
           public EorCountryValidationsPartTimeHoliday read(JsonReader in) throws IOException {
             ...
             EorCountryValidationsPartTimeHoliday instance = thisAdapter.fromJsonTree(jsonObj);
