...
import com.konfigthis.client.model.GenericResultCreatedData;
...
public class GenericResultCreated {
  ...
  private GenericResultCreatedData data;

  public GenericResultCreated() {
  }

  public GenericResultCreated data(GenericResultCreatedData data) {
  ...
  **/
  ...
  public GenericResultCreatedData getData() {
    return data;
  }


  public void setData(GenericResultCreatedData data) {
   ...
   * @return the GenericResultCreated instance itself
   */
  public GenericResultCreated putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, genericResultCreated.data)&&
        Objects.equals(this.additionalProperties, genericResultCreated.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenericResultCreated
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GenericResultCreated.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      GenericResultCreatedData.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GenericResultCreated>() {
           ...
           public GenericResultCreated read(JsonReader in) throws IOException {
             ...
             GenericResultCreated instance = thisAdapter.fromJsonTree(jsonObj);
