...
public class InvoiceObject {
  ...
  private List<Invoice> rows = null;

  public InvoiceObject() {
  }

  public InvoiceObject rows(List<Invoice> rows) {
  ...
  public InvoiceObject addRowsItem(Invoice rowsItem) {
    if (this.rows == null) {
  ...
  **/
  ...
  public void setRows(List<Invoice> rows) {
   ...
   * @return the InvoiceObject instance itself
   */
  public InvoiceObject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rows, invoiceObject.rows)&&
        Objects.equals(this.additionalProperties, invoiceObject.additionalProperties);
  }
      ...
      if (jsonObj.get("rows") != null && !jsonObj.get("rows").isJsonNull()) {
        ...
        if (jsonArrayrows != null) {
          ...
          for (int i = 0; i < jsonArrayrows.size(); i++) {
            Invoice.validateJsonObject(jsonArrayrows.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InvoiceObject>() {
           ...
           public InvoiceObject read(JsonReader in) throws IOException {
             ...
             InvoiceObject instance = thisAdapter.fromJsonTree(jsonObj);
