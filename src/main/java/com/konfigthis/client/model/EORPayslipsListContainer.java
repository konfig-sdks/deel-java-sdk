...
import com.konfigthis.client.model.Payslips;
...
public class EORPayslipsListContainer {
  ...
  **/
   ...
   * @return the EORPayslipsListContainer instance itself
   */
  public EORPayslipsListContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, eoRPayslipsListContainer.data)&&
        Objects.equals(this.additionalProperties, eoRPayslipsListContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EORPayslipsListContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EORPayslipsListContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        Payslips.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EORPayslipsListContainer>() {
           ...
           public EORPayslipsListContainer read(JsonReader in) throws IOException {
             ...
             EORPayslipsListContainer instance = thisAdapter.fromJsonTree(jsonObj);
