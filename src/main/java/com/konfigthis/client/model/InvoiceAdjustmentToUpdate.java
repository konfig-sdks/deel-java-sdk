 ...
 */
@ApiModel(description = "Details of invoice adjustment to update.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class InvoiceAdjustmentToUpdate {
  ...
  **/
  ...
  public InvoiceAdjustmentToUpdate amount(Double amount) {
  ...
  public InvoiceAdjustmentToUpdate amount(Integer amount) {
    if (amount != null && amount < 0) {
      throw new IllegalArgumentException("Invalid value for amount. Must be greater than or equal to 0.");
    }
  ...
  **/
   ...
   * @return the InvoiceAdjustmentToUpdate instance itself
   */
  public InvoiceAdjustmentToUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, invoiceAdjustmentToUpdate.description) &&
        ...
        Objects.equals(this.additionalProperties, invoiceAdjustmentToUpdate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, amount, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceAdjustmentToUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceAdjustmentToUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InvoiceAdjustmentToUpdate>() {
           ...
           public InvoiceAdjustmentToUpdate read(JsonReader in) throws IOException {
             ...
             InvoiceAdjustmentToUpdate instance = thisAdapter.fromJsonTree(jsonObj);
