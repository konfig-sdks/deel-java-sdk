...
import com.konfigthis.client.model.GlobalPayrollG2NReport;
...
public class GlobalPayrollG2NReportContainer {
  ...
  **/
   ...
   * @return the GlobalPayrollG2NReportContainer instance itself
   */
  public GlobalPayrollG2NReportContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, globalPayrollG2NReportContainer.data)&&
        Objects.equals(this.additionalProperties, globalPayrollG2NReportContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GlobalPayrollG2NReportContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GlobalPayrollG2NReportContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        GlobalPayrollG2NReport.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GlobalPayrollG2NReportContainer>() {
           ...
           public GlobalPayrollG2NReportContainer read(JsonReader in) throws IOException {
             ...
             GlobalPayrollG2NReportContainer instance = thisAdapter.fromJsonTree(jsonObj);
