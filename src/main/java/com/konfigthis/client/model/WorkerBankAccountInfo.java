...
public class WorkerBankAccountInfo {
  ...
  **/
   ...
   * @return the WorkerBankAccountInfo instance itself
   */
  public WorkerBankAccountInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fullName, workerBankAccountInfo.fullName) &&
        ...
        Objects.equals(this.additionalProperties, workerBankAccountInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fullName, phone, addressLine1, addressLine2, city, provinceState, postal, bankName, countryCode, bankCountryCode, swiftBic, accountNumber, bankCode, originalName, taxId, branchCode, currencyCode, bankBranchName, iban, email, ribNumber, accountType, achRoutingNumber, id, createdAt, updatedAt, status, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkerBankAccountInfo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkerBankAccountInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkerBankAccountInfo>() {
           ...
           public WorkerBankAccountInfo read(JsonReader in) throws IOException {
             ...
             WorkerBankAccountInfo instance = thisAdapter.fromJsonTree(jsonObj);
