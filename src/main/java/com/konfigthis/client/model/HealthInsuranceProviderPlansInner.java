...
public class HealthInsuranceProviderPlansInner {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "USA Healthcare Plan", value = "Insurance plan name.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "570.00", value = "Insurance price.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "USD", value = "Insurance payment currency.")
  ...
  **/
   ...
   * @return the HealthInsuranceProviderPlansInner instance itself
   */
  public HealthInsuranceProviderPlansInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, healthInsuranceProviderPlansInner.id) &&
        ...
        Objects.equals(this.additionalProperties, healthInsuranceProviderPlansInner.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, price, currency, isEnabled, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to HealthInsuranceProviderPlansInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HealthInsuranceProviderPlansInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<HealthInsuranceProviderPlansInner>() {
           ...
           public HealthInsuranceProviderPlansInner read(JsonReader in) throws IOException {
             ...
             HealthInsuranceProviderPlansInner instance = thisAdapter.fromJsonTree(jsonObj);
