...
public class BasicTimesheetContract {
  ...
  **/
   ...
   * @return the BasicTimesheetContract instance itself
   */
  public BasicTimesheetContract putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, basicTimesheetContract.title) &&
        Objects.equals(this.id, basicTimesheetContract.id) &&
        Objects.equals(this.type, basicTimesheetContract.type)&&
        Objects.equals(this.additionalProperties, basicTimesheetContract.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, id, type, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BasicTimesheetContract
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BasicTimesheetContract.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BasicTimesheetContract>() {
           ...
           public BasicTimesheetContract read(JsonReader in) throws IOException {
             ...
             BasicTimesheetContract instance = thisAdapter.fromJsonTree(jsonObj);
