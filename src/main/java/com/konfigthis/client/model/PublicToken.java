...
public class PublicToken {
  ...
  **/
  ...
  @ApiModelProperty(example = "eXampL3.t0Ken", required = true, value = "Public token.")
   ...
   * @return the PublicToken instance itself
   */
  public PublicToken putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.token, publicToken.token)&&
        Objects.equals(this.additionalProperties, publicToken.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PublicToken
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PublicToken.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PublicToken>() {
           ...
           public PublicToken read(JsonReader in) throws IOException {
             ...
             PublicToken instance = thisAdapter.fromJsonTree(jsonObj);
