...
public class CreatePeopleTimeoff {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2022-09-03T00:00:00.000Z", required = true, value = "Start date of employee's time off.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2022-09-05T00:00:00.000Z", required = true, value = "End date of employee's time off.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Holiday", required = true, value = "Description for employee's time off.")
  ...
  **/
   ...
   * @return the CreatePeopleTimeoff instance itself
   */
  public CreatePeopleTimeoff putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, createPeopleTimeoff.type) &&
        ...
        Objects.equals(this.additionalProperties, createPeopleTimeoff.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreatePeopleTimeoff
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreatePeopleTimeoff.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreatePeopleTimeoff>() {
           ...
           public CreatePeopleTimeoff read(JsonReader in) throws IOException {
             ...
             CreatePeopleTimeoff instance = thisAdapter.fromJsonTree(jsonObj);
