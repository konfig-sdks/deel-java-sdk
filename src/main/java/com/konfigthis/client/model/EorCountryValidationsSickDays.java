...
public class EorCountryValidationsSickDays {
  ...
  **/
  ...
  @ApiModelProperty(example = "0", value = "Minimum number of sick days required for a legally compliant contract.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Maximum number of sick days allowed for a legally compliant contract.")
   ...
   * @return the EorCountryValidationsSickDays instance itself
   */
  public EorCountryValidationsSickDays putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.min, eorCountryValidationsSickDays.min) &&
        ...
        Objects.equals(this.additionalProperties, eorCountryValidationsSickDays.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EorCountryValidationsSickDays
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EorCountryValidationsSickDays.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EorCountryValidationsSickDays>() {
           ...
           public EorCountryValidationsSickDays read(JsonReader in) throws IOException {
             ...
             EorCountryValidationsSickDays instance = thisAdapter.fromJsonTree(jsonObj);
