...
public class ContractToTerminate {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A message for the termination")
   ...
   * @return the ContractToTerminate instance itself
   */
  public ContractToTerminate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.completionDate, contractToTerminate.completionDate) &&
        ...
        Objects.equals(this.additionalProperties, contractToTerminate.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(completionDate, terminateNow, message, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContractToTerminate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContractToTerminate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContractToTerminate>() {
           ...
           public ContractToTerminate read(JsonReader in) throws IOException {
             ...
             ContractToTerminate instance = thisAdapter.fromJsonTree(jsonObj);
