...
public class EORContractBenefitsInnerEnrollmentDetailsStandard {
  ...
  **/
  ...
  @ApiModelProperty(example = "100", value = "Standard monthly cost.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "50", value = "Standard monthly contribution.")
   ...
   * @return the EORContractBenefitsInnerEnrollmentDetailsStandard instance itself
   */
  public EORContractBenefitsInnerEnrollmentDetailsStandard putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.monthlyCost, eoRContractBenefitsInnerEnrollmentDetailsStandard.monthlyCost) &&
        ...
        Objects.equals(this.additionalProperties, eoRContractBenefitsInnerEnrollmentDetailsStandard.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(monthlyCost, monthlyContribution, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EORContractBenefitsInnerEnrollmentDetailsStandard
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EORContractBenefitsInnerEnrollmentDetailsStandard.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (!jsonObj.get("monthly_cost").isJsonNull() && (jsonObj.get("monthly_cost") != null && !jsonObj.get("monthly_cost").isJsonNull()) && !jsonObj.get("monthly_cost").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("monthly_contribution").isJsonNull() && (jsonObj.get("monthly_contribution") != null && !jsonObj.get("monthly_contribution").isJsonNull()) && !jsonObj.get("monthly_contribution").isJsonPrimitive()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EORContractBenefitsInnerEnrollmentDetailsStandard>() {
           ...
           public EORContractBenefitsInnerEnrollmentDetailsStandard read(JsonReader in) throws IOException {
             ...
             EORContractBenefitsInnerEnrollmentDetailsStandard instance = thisAdapter.fromJsonTree(jsonObj);
