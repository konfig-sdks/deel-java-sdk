 ...
 * Pension provider.
 */
@ApiModel(description = "Pension provider.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PensionProvider {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "US Pension", value = "Name of pension provider.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://bit.ly/3uW72fp", value = "Pension provider's home page url.")
  ...
  **/
   ...
   * @return the PensionProvider instance itself
   */
  public PensionProvider putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, pensionProvider.id) &&
        ...
        Objects.equals(this.additionalProperties, pensionProvider.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, homePageUrl, contribution, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PensionProvider
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PensionProvider.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("contribution") != null && !jsonObj.get("contribution").isJsonNull()) {
        Contribution.validateJsonObject(jsonObj.getAsJsonObject("contribution"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PensionProvider>() {
           ...
           public PensionProvider read(JsonReader in) throws IOException {
             ...
             PensionProvider instance = thisAdapter.fromJsonTree(jsonObj);
