...
public class GPContractCreatedEmployee {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Employee's email address.")
  ...
  **/
   ...
   * @return the GPContractCreatedEmployee instance itself
   */
  public GPContractCreatedEmployee putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.firstName, gpContractCreatedEmployee.firstName) &&
        ...
        Objects.equals(this.additionalProperties, gpContractCreatedEmployee.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firstName, lastName, email, employeeNumber, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GPContractCreatedEmployee
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GPContractCreatedEmployee.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GPContractCreatedEmployee>() {
           ...
           public GPContractCreatedEmployee read(JsonReader in) throws IOException {
             ...
             GPContractCreatedEmployee instance = thisAdapter.fromJsonTree(jsonObj);
