...
public class GetEmployeeComplianceDocumentsContainerDataDocumentsInner {
  ...
  **/
  ...
  @ApiModelProperty(example = "This document is needed for tax purposes.", value = "A short description of the document.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Example Document", value = "The name of the document.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Denotes if this document has a template available for download")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Denotes if the document is available to fill out on Deel.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Denotes if the document is optional or required.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "GB", value = "The country associated with this document.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2023-01-01T12:00:00.000Z", value = "The timestamp when this document was uploaded / supplied to Deel.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The list of filenames for the associated uploaded documents.")
   ...
   * @return the GetEmployeeComplianceDocumentsContainerDataDocumentsInner instance itself
   */
  public GetEmployeeComplianceDocumentsContainerDataDocumentsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, getEmployeeComplianceDocumentsContainerDataDocumentsInner.description) &&
        Objects.equals(this.id, getEmployeeComplianceDocumentsContainerDataDocumentsInner.id) &&
        ...
        Objects.equals(this.additionalProperties, getEmployeeComplianceDocumentsContainerDataDocumentsInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, id, name, hasTemplate, fillable, isOptional, country, uploadedAt, filenames, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetEmployeeComplianceDocumentsContainerDataDocumentsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetEmployeeComplianceDocumentsContainerDataDocumentsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("filenames") != null && !jsonObj.get("filenames").isJsonArray()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetEmployeeComplianceDocumentsContainerDataDocumentsInner>() {
           ...
           public GetEmployeeComplianceDocumentsContainerDataDocumentsInner read(JsonReader in) throws IOException {
             ...
             GetEmployeeComplianceDocumentsContainerDataDocumentsInner instance = thisAdapter.fromJsonTree(jsonObj);
