...
public class GPEmployeePTOUpdateData {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "15", required = true, value = "Enter the number of holidays.")
   ...
   * @return the GPEmployeePTOUpdateData instance itself
   */
  public GPEmployeePTOUpdateData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accrualStartDate, gpEmployeePTOUpdateData.accrualStartDate) &&
        ...
        Objects.equals(this.additionalProperties, gpEmployeePTOUpdateData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accrualStartDate, yearlyAllowance, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GPEmployeePTOUpdateData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GPEmployeePTOUpdateData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GPEmployeePTOUpdateData>() {
           ...
           public GPEmployeePTOUpdateData read(JsonReader in) throws IOException {
             ...
             GPEmployeePTOUpdateData instance = thisAdapter.fromJsonTree(jsonObj);
