...
import com.konfigthis.client.model.GenericResultUpdatedData;
...
public class GenericResultUpdated {
  ...
  private GenericResultUpdatedData data;

  public GenericResultUpdated() {
  }

  public GenericResultUpdated data(GenericResultUpdatedData data) {
  ...
  **/
  ...
  public GenericResultUpdatedData getData() {
    return data;
  }


  public void setData(GenericResultUpdatedData data) {
   ...
   * @return the GenericResultUpdated instance itself
   */
  public GenericResultUpdated putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, genericResultUpdated.data)&&
        Objects.equals(this.additionalProperties, genericResultUpdated.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenericResultUpdated
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GenericResultUpdated.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      GenericResultUpdatedData.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GenericResultUpdated>() {
           ...
           public GenericResultUpdated read(JsonReader in) throws IOException {
             ...
             GenericResultUpdated instance = thisAdapter.fromJsonTree(jsonObj);
