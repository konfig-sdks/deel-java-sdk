...
public class PaymentStatementInitiatedWebhook {
  ...
  private List<Double> billingInvoices = new ArrayList<>();

  public static final String SERIALIZED_NAME_INVOICES = "invoices";
  @SerializedName(SERIALIZED_NAME_INVOICES)
  private List<Double> invoices = new ArrayList<>();

  public PaymentStatementInitiatedWebhook() {
  }

  public PaymentStatementInitiatedWebhook billingInvoices(List<Double> billingInvoices) {
  ...
  public PaymentStatementInitiatedWebhook addBillingInvoicesItem(Double billingInvoicesItem) {
  ...
  **/
  ...
  public List<Double> getBillingInvoices() {
    return billingInvoices;
  }


  public void setBillingInvoices(List<Double> billingInvoices) {
  ...
  public PaymentStatementInitiatedWebhook invoices(List<Double> invoices) {
  ...
  public PaymentStatementInitiatedWebhook addInvoicesItem(Double invoicesItem) {
  ...
  **/
   ...
   * @return the PaymentStatementInitiatedWebhook instance itself
   */
  public PaymentStatementInitiatedWebhook putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.billingInvoices, paymentStatementInitiatedWebhook.billingInvoices) &&
        ...
        Objects.equals(this.additionalProperties, paymentStatementInitiatedWebhook.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(billingInvoices, invoices, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentStatementInitiatedWebhook
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentStatementInitiatedWebhook.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PaymentStatementInitiatedWebhook>() {
           ...
           public PaymentStatementInitiatedWebhook read(JsonReader in) throws IOException {
             ...
             PaymentStatementInitiatedWebhook instance = thisAdapter.fromJsonTree(jsonObj);
