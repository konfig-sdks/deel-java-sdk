...
public class CandidateToPatchContainer {
  ...
  **/
   ...
   * @return the CandidateToPatchContainer instance itself
   */
  public CandidateToPatchContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, candidateToPatchContainer.data)&&
        Objects.equals(this.additionalProperties, candidateToPatchContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CandidateToPatchContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CandidateToPatchContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      CandidateToPatch.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CandidateToPatchContainer>() {
           ...
           public CandidateToPatchContainer read(JsonReader in) throws IOException {
             ...
             CandidateToPatchContainer instance = thisAdapter.fromJsonTree(jsonObj);
