...
public class PayslipDownloadUrl {
  ...
  **/
  ...
  @ApiModelProperty(example = "https://s3.eu-west-1.amazonaws.com/api-dev-eks.letsdeel.com/employee_payslips/ApdZbLvq0r0E_Payslip_Kulvear_Bowie_2023-12-31.pdf?AWSAccessKeyId=ASIATHF2L5PZ545TTFF7&Expires=1698149134&Signature=DmqwQiXY%2FHmPS%2FYBcB2DOZ9SDVA%3D&x-amz-security-token=zxc", required = true, value = "")
   ...
   * @return the PayslipDownloadUrl instance itself
   */
  public PayslipDownloadUrl putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, payslipDownloadUrl.url)&&
        Objects.equals(this.additionalProperties, payslipDownloadUrl.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayslipDownloadUrl
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayslipDownloadUrl.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PayslipDownloadUrl>() {
           ...
           public PayslipDownloadUrl read(JsonReader in) throws IOException {
             ...
             PayslipDownloadUrl instance = thisAdapter.fromJsonTree(jsonObj);
