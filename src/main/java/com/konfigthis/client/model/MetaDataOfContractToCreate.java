 ...
 */
@ApiModel(description = "Additional custom info about a contract")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class MetaDataOfContractToCreate {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Require the contractor to upload necessary compliance documents as per their country’s labor laws.")
  ...
  **/
   ...
   * @return the MetaDataOfContractToCreate instance itself
   */
  public MetaDataOfContractToCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.documentsRequired, metaDataOfContractToCreate.documentsRequired) &&
        ...
        Objects.equals(this.additionalProperties, metaDataOfContractToCreate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(documentsRequired, isMainIncome, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MetaDataOfContractToCreate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MetaDataOfContractToCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MetaDataOfContractToCreate>() {
           ...
           public MetaDataOfContractToCreate read(JsonReader in) throws IOException {
             ...
             MetaDataOfContractToCreate instance = thisAdapter.fromJsonTree(jsonObj);
