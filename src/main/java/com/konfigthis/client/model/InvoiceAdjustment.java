...
public class InvoiceAdjustment {
  ...
  **/
  ...
  public InvoiceAdjustment invoiceId(Double invoiceId) {
  ...
  public InvoiceAdjustment invoiceId(Integer invoiceId) {
  ...
  **/
  ...
  public InvoiceAdjustment quantity(Double quantity) {
  ...
  public InvoiceAdjustment quantity(Integer quantity) {
  ...
  **/
  ...
  public InvoiceAdjustment worksheet(BasicInvoiceAdjustmentWorksheet worksheet) {
  ...
  **/
  ...
  public InvoiceAdjustment reviewedBy(BasicInvoiceAdjustmentReviewedBy reviewedBy) {
  ...
  **/
  ...
  public InvoiceAdjustment reportedBy(BasicInvoiceAdjustmentReportedBy reportedBy) {
  ...
  **/
   ...
   * @return the InvoiceAdjustment instance itself
   */
  public InvoiceAdjustment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, invoiceAdjustment.description) &&
        Objects.equals(this.id, invoiceAdjustment.id) &&
        ...
        Objects.equals(this.additionalProperties, invoiceAdjustment.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, id, type, status, dateSubmitted, currencyCode, invoiceId, quantity, totalAmount, createdAt, scale, customScale, attachment, worksheet, reviewedBy, contract, paymentCycle, reportedBy, approvers, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceAdjustment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceAdjustment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (int i = 0; i < jsonArrayapprovers.size(); i++) {
        InvoiceAdjustmentApprover.validateJsonObject(jsonArrayapprovers.get(i).getAsJsonObject());
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InvoiceAdjustment>() {
           ...
           public InvoiceAdjustment read(JsonReader in) throws IOException {
             ...
             InvoiceAdjustment instance = thisAdapter.fromJsonTree(jsonObj);
