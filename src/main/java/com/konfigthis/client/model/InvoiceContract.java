...
public class InvoiceContract {
  ...
  **/
  ...
  @ApiModelProperty(example = "rhCTiRd9Mad41RwjsFWw-", required = true, value = "Unique identifier of a Deel contract.")
  ...
  **/
  ...
  @ApiModelProperty(example = "Lisandro Shanahan-Dynamic Web Specialist", value = "Contract title.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "pay_as_you_go_time_based", required = true, value = "Type of Deel contract.")
   ...
   * @return the InvoiceContract instance itself
   */
  public InvoiceContract putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, invoiceContract.id) &&
        ...
        Objects.equals(this.additionalProperties, invoiceContract.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, contractType, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceContract
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceContract.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InvoiceContract>() {
           ...
           public InvoiceContract read(JsonReader in) throws IOException {
             ...
             InvoiceContract instance = thisAdapter.fromJsonTree(jsonObj);
