...
public class BankAccountValueAllowed {
  ...
  **/
  ...
  @ApiModelProperty(example = "AR", value = "The key of the allowed value.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Argentina", value = "The name of the allowed value.")
   ...
   * @return the BankAccountValueAllowed instance itself
   */
  public BankAccountValueAllowed putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.value, bankAccountValueAllowed.value) &&
        ...
        Objects.equals(this.additionalProperties, bankAccountValueAllowed.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BankAccountValueAllowed
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BankAccountValueAllowed.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BankAccountValueAllowed>() {
           ...
           public BankAccountValueAllowed read(JsonReader in) throws IOException {
             ...
             BankAccountValueAllowed instance = thisAdapter.fromJsonTree(jsonObj);
