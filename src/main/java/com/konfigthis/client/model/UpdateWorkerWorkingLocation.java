...
public class UpdateWorkerWorkingLocation {
  ...
  **/
   ...
   * @return the UpdateWorkerWorkingLocation instance itself
   */
  public UpdateWorkerWorkingLocation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.workingLocationId, updateWorkerWorkingLocation.workingLocationId)&&
        Objects.equals(this.additionalProperties, updateWorkerWorkingLocation.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(workingLocationId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateWorkerWorkingLocation
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateWorkerWorkingLocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateWorkerWorkingLocation>() {
           ...
           public UpdateWorkerWorkingLocation read(JsonReader in) throws IOException {
             ...
             UpdateWorkerWorkingLocation instance = thisAdapter.fromJsonTree(jsonObj);
