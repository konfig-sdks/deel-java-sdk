...
public class GPPayrollEventReportsInner {
  ...
  **/
  ...
  @ApiModelProperty(example = "clqmd5qb07xwevi01cd5kb6kw", required = true, value = "")
  ...
  **/
   ...
   * @return the GPPayrollEventReportsInner instance itself
   */
  public GPPayrollEventReportsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, gpPayrollEventReportsInner.id) &&
        ...
        Objects.equals(this.additionalProperties, gpPayrollEventReportsInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, status, startDate, lockDate, endDate, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GPPayrollEventReportsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GPPayrollEventReportsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GPPayrollEventReportsInner>() {
           ...
           public GPPayrollEventReportsInner read(JsonReader in) throws IOException {
             ...
             GPPayrollEventReportsInner instance = thisAdapter.fromJsonTree(jsonObj);
