...
public class ContractSignatureToCreate {
  ...
  private Double contractTemplateId;
  ...
  public ContractSignatureToCreate clientSignature(String clientSignature) {
    ...
    if (clientSignature != null && clientSignature.length() < 2) {
      throw new IllegalArgumentException("Invalid value for clientSignature. Length must be greater than or equal to 2.");
    }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Signature of client.")
  ...
  public ContractSignatureToCreate contractTemplateId(Double contractTemplateId) {
  ...
  public ContractSignatureToCreate contractTemplateId(Integer contractTemplateId) {
    
    
    
    
    this.contractTemplateId = contractTemplateId.doubleValue();
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(example = "12345678", value = "Please use null to use default Deel contract template; otherwise you can use the template you created and customized. If template ID is not in payload, template stays unchanged.")

  public Double getContractTemplateId() {
    return contractTemplateId;
  }


  public void setContractTemplateId(Double contractTemplateId) {
   ...
   * @return the ContractSignatureToCreate instance itself
   */
  public ContractSignatureToCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientSignature, contractSignatureToCreate.clientSignature) &&
        ...
        Objects.equals(this.additionalProperties, contractSignatureToCreate.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientSignature, contractTemplateId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContractSignatureToCreate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContractSignatureToCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContractSignatureToCreate>() {
           ...
           public ContractSignatureToCreate read(JsonReader in) throws IOException {
             ...
             ContractSignatureToCreate instance = thisAdapter.fromJsonTree(jsonObj);
