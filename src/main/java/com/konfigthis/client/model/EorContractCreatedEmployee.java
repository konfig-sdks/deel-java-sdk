...
public class EorContractCreatedEmployee {
  ...
  **/
  ...
  @ApiModelProperty(value = "Employee's legal name.")
  ...
  **/
   ...
   * @return the EorContractCreatedEmployee instance itself
   */
  public EorContractCreatedEmployee putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.legalName, eorContractCreatedEmployee.legalName) &&
        ...
        Objects.equals(this.additionalProperties, eorContractCreatedEmployee.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(legalName, firstName, lastName, email, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EorContractCreatedEmployee
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EorContractCreatedEmployee.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EorContractCreatedEmployee>() {
           ...
           public EorContractCreatedEmployee read(JsonReader in) throws IOException {
             ...
             EorContractCreatedEmployee instance = thisAdapter.fromJsonTree(jsonObj);
