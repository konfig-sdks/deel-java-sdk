...
public class OffCyclePaymentToCreateContainer {
  ...
  **/
   ...
   * @return the OffCyclePaymentToCreateContainer instance itself
   */
  public OffCyclePaymentToCreateContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, offCyclePaymentToCreateContainer.data)&&
        Objects.equals(this.additionalProperties, offCyclePaymentToCreateContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OffCyclePaymentToCreateContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OffCyclePaymentToCreateContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      OffCyclePaymentToCreate.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OffCyclePaymentToCreateContainer>() {
           ...
           public OffCyclePaymentToCreateContainer read(JsonReader in) throws IOException {
             ...
             OffCyclePaymentToCreateContainer instance = thisAdapter.fromJsonTree(jsonObj);
