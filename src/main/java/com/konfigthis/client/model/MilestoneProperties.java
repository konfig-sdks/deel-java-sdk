...
public class MilestoneProperties {
  ...
  **/
   ...
   * @return the MilestoneProperties instance itself
   */
  public MilestoneProperties putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, milestoneProperties.title) &&
        Objects.equals(this.description, milestoneProperties.description) &&
        Objects.equals(this.amount, milestoneProperties.amount)&&
        Objects.equals(this.additionalProperties, milestoneProperties.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, description, amount, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MilestoneProperties
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MilestoneProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MilestoneProperties>() {
           ...
           public MilestoneProperties read(JsonReader in) throws IOException {
             ...
             MilestoneProperties instance = thisAdapter.fromJsonTree(jsonObj);
