 ...
 */
@ApiModel(description = "Choose the Deel legal entity for this contract. Use legal entity endpoint to retrieve a list of legal entities in your organization.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ContractToCreateSharedClientLegalEntity {
  ...
  **/
   ...
   * @return the ContractToCreateSharedClientLegalEntity instance itself
   */
  public ContractToCreateSharedClientLegalEntity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, contractToCreateSharedClientLegalEntity.id)&&
        Objects.equals(this.additionalProperties, contractToCreateSharedClientLegalEntity.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContractToCreateSharedClientLegalEntity
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContractToCreateSharedClientLegalEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContractToCreateSharedClientLegalEntity>() {
           ...
           public ContractToCreateSharedClientLegalEntity read(JsonReader in) throws IOException {
             ...
             ContractToCreateSharedClientLegalEntity instance = thisAdapter.fromJsonTree(jsonObj);
