...
import com.konfigthis.client.model.EorTimeoffsEmployeeItem;
...
public class EorClientTimeoffs {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "List of employee time offs.")
  ...
  public EorClientTimeoffs totalRequests(Double totalRequests) {
  ...
  public EorClientTimeoffs totalRequests(Integer totalRequests) {
    
    
    
    
    this.totalRequests = totalRequests.doubleValue();
    return this;
  }
  ...
  **/
   ...
   * @return the EorClientTimeoffs instance itself
   */
  public EorClientTimeoffs putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.employees, eorClientTimeoffs.employees) &&
        ...
        Objects.equals(this.additionalProperties, eorClientTimeoffs.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(employees, totalRequests, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EorClientTimeoffs
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EorClientTimeoffs.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (int i = 0; i < jsonArrayemployees.size(); i++) {
        EorTimeoffsEmployeeItem.validateJsonObject(jsonArrayemployees.get(i).getAsJsonObject());
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EorClientTimeoffs>() {
           ...
           public EorClientTimeoffs read(JsonReader in) throws IOException {
             ...
             EorClientTimeoffs instance = thisAdapter.fromJsonTree(jsonObj);
