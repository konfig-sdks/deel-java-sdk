...
public class PeoplePayment {
  ...
  public PeoplePayment rate(Double rate) {
  ...
  public PeoplePayment rate(Integer rate) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The payment rate")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The currency code (ISO 4217) for the payment")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name of the contract associated with the payment")
   ...
   * @return the PeoplePayment instance itself
   */
  public PeoplePayment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rate, peoplePayment.rate) &&
        ...
        Objects.equals(this.additionalProperties, peoplePayment.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PeoplePayment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PeoplePayment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PeoplePayment>() {
           ...
           public PeoplePayment read(JsonReader in) throws IOException {
             ...
             PeoplePayment instance = thisAdapter.fromJsonTree(jsonObj);
