 ...
 */
@ApiModel(description = "Range of the number of holidays.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class EorCountryValidationsHoliday {
  ...
  **/
  ...
  @ApiModelProperty(example = "20", value = "Minimum number of holidays required for a legally compliant contract.")
   ...
   * @return the EorCountryValidationsHoliday instance itself
   */
  public EorCountryValidationsHoliday putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.min, eorCountryValidationsHoliday.min)&&
        Objects.equals(this.additionalProperties, eorCountryValidationsHoliday.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(min, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EorCountryValidationsHoliday
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EorCountryValidationsHoliday.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EorCountryValidationsHoliday>() {
           ...
           public EorCountryValidationsHoliday read(JsonReader in) throws IOException {
             ...
             EorCountryValidationsHoliday instance = thisAdapter.fromJsonTree(jsonObj);
