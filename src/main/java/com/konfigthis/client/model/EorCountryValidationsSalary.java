 ...
 * Salary range.
 */
@ApiModel(description = "Salary range.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class EorCountryValidationsSalary {
  ...
  **/
  ...
  @ApiModelProperty(example = "14544.00", value = "Minimum wage for a legally compliant contract.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2649300.00", value = "Maximum wage allowed for a legally compliant contract.")
  ...
  **/
   ...
   * @return the EorCountryValidationsSalary instance itself
   */
  public EorCountryValidationsSalary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.min, eorCountryValidationsSalary.min) &&
        ...
        Objects.equals(this.additionalProperties, eorCountryValidationsSalary.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(min, max, frequency, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EorCountryValidationsSalary
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EorCountryValidationsSalary.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EorCountryValidationsSalary>() {
           ...
           public EorCountryValidationsSalary read(JsonReader in) throws IOException {
             ...
             EorCountryValidationsSalary instance = thisAdapter.fromJsonTree(jsonObj);
