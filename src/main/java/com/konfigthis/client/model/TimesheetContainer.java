...
import com.konfigthis.client.model.Timesheet;
...
public class TimesheetContainer {
  ...
  **/
   ...
   * @return the TimesheetContainer instance itself
   */
  public TimesheetContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, timesheetContainer.data)&&
        Objects.equals(this.additionalProperties, timesheetContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      Timesheet.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TimesheetContainer>() {
           ...
           public TimesheetContainer read(JsonReader in) throws IOException {
             ...
             TimesheetContainer instance = thisAdapter.fromJsonTree(jsonObj);
