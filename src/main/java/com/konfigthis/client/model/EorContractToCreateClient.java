...
public class EorContractToCreateClient {
  ...
  **/
   ...
   * @return the EorContractToCreateClient instance itself
   */
  public EorContractToCreateClient putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.legalEntity, eorContractToCreateClient.legalEntity) &&
        ...
        Objects.equals(this.additionalProperties, eorContractToCreateClient.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EorContractToCreateClient
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EorContractToCreateClient.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("legal_entity") != null && !jsonObj.get("legal_entity").isJsonNull()) {
        EorContractToCreateSeniority.validateJsonObject(jsonObj.getAsJsonObject("legal_entity"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EorContractToCreateClient>() {
           ...
           public EorContractToCreateClient read(JsonReader in) throws IOException {
             ...
             EorContractToCreateClient instance = thisAdapter.fromJsonTree(jsonObj);
