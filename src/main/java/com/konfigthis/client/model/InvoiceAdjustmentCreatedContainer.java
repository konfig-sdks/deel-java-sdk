...
import com.konfigthis.client.model.InvoiceAdjustmentCreated;
...
public class InvoiceAdjustmentCreatedContainer {
  ...
  **/
   ...
   * @return the InvoiceAdjustmentCreatedContainer instance itself
   */
  public InvoiceAdjustmentCreatedContainer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, invoiceAdjustmentCreatedContainer.data)&&
        Objects.equals(this.additionalProperties, invoiceAdjustmentCreatedContainer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceAdjustmentCreatedContainer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceAdjustmentCreatedContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      InvoiceAdjustmentCreated.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InvoiceAdjustmentCreatedContainer>() {
           ...
           public InvoiceAdjustmentCreatedContainer read(JsonReader in) throws IOException {
             ...
             InvoiceAdjustmentCreatedContainer instance = thisAdapter.fromJsonTree(jsonObj);
