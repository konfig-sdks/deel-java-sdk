 ...
 */
@ApiModel(description = "It may be called states, provinces, prefectures or regions, or none at all")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class StateOfCountry {
  ...
  **/
  ...
  @ApiModelProperty(example = "NY", required = true, value = "Territory code.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "New York", required = true, value = "Territory name.")
   ...
   * @return the StateOfCountry instance itself
   */
  public StateOfCountry putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, stateOfCountry.code) &&
        ...
        Objects.equals(this.additionalProperties, stateOfCountry.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to StateOfCountry
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StateOfCountry.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StateOfCountry>() {
           ...
           public StateOfCountry read(JsonReader in) throws IOException {
             ...
             StateOfCountry instance = thisAdapter.fromJsonTree(jsonObj);
