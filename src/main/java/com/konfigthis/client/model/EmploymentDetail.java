...
import com.konfigthis.client.model.EmploymentDetailTeam;
import com.konfigthis.client.model.PeopleClientLegalEntity;
import com.konfigthis.client.model.PeoplePayment;
...
public class EmploymentDetail {
  ...
  private List<String> contractCoverage = null;
  ...
  **/
  ...
  @ApiModelProperty(example = "mzj524j", value = "Unique identifier for the employment.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Khizar Naeem", value = "Name of the employee.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "some@example.com", value = "The work email of the employee.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Active", value = "The state of employment.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "USA", value = "The country of employment.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether the employment has ended.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "EST", value = "The timezone of the employment.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Access Field Technician", value = "The job title of the employment.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Junior (Individual Contributor Level 1)", value = "The seniority level of the employment.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The start date of the employment.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "work.email@example.com", value = "The work email of the employment.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "contractor", value = "The type of hiring of the employment.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "onboarding", value = "The current hiring status of the employment.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2023-06-20T00:00:00.000Z", value = "The completion date of the employment contract.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "waiting_for_client_sign", value = "The status of the employment contract.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether the employee voluntarily left the employment.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[\"no_coverage\"]", value = "The coverage of the employment contract.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "onboarding_overdue", value = "The new hiring status of the employment.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether the employment has an EOR termination.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether the employment contract is archived.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Whether the contract has a contractor.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Whether the user contract is deleted.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Invited", value = "The HRIS direct employee invitation status.")
   ...
   * @return the EmploymentDetail instance itself
   */
  public EmploymentDetail putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, employmentDetail.id) &&
        ...
        Objects.equals(this.additionalProperties, employmentDetail.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmploymentDetail
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmploymentDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("team") != null && !jsonObj.get("team").isJsonNull()) {
        EmploymentDetailTeam.validateJsonObject(jsonObj.getAsJsonObject("team"));
      }
      ...
      if (jsonObj.get("payment") != null && !jsonObj.get("payment").isJsonNull()) {
        PeoplePayment.validateJsonObject(jsonObj.getAsJsonObject("payment"));
      }
      ...
      if (jsonObj.get("contract_coverage") != null && !jsonObj.get("contract_coverage").isJsonArray()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EmploymentDetail>() {
           ...
           public EmploymentDetail read(JsonReader in) throws IOException {
             ...
             EmploymentDetail instance = thisAdapter.fromJsonTree(jsonObj);
