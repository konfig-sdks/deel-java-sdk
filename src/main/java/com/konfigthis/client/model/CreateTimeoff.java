...
public class CreateTimeoff {
  ...
  **/
  ...
  @ApiModelProperty(example = "2022-09-03T00:00:00.000Z", value = "Start date of employee's time off.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2022-09-05T00:00:00.000Z", value = "End date of employee's time off.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "If true, then multiple time off days were requested. You must supply a start and end date. If false, end date is ignored")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Holiday", value = "Description for employee's time off.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Is the start day a half day?")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Birthday", value = "Custom name for this time off.")
   ...
   * @return the CreateTimeoff instance itself
   */
  public CreateTimeoff putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, createTimeoff.type) &&
        ...
        Objects.equals(this.additionalProperties, createTimeoff.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, startDate, endDate, withMultipleDates, reason, isStartDateHalfDay, isEndDateHalfDay, otherTimeoffName, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateTimeoff
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateTimeoff.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateTimeoff>() {
           ...
           public CreateTimeoff read(JsonReader in) throws IOException {
             ...
             CreateTimeoff instance = thisAdapter.fromJsonTree(jsonObj);
