...
public class TimesheetReviewsToCreate {
  ...
  **/
  ...
  public TimesheetReviewsToCreate ids(List<Object> ids) {
  ...
  public TimesheetReviewsToCreate addIdsItem(Object idsItem) {
  ...
  **/
   ...
   * @return the TimesheetReviewsToCreate instance itself
   */
  public TimesheetReviewsToCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, timesheetReviewsToCreate.status) &&
        ...
        Objects.equals(this.additionalProperties, timesheetReviewsToCreate.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimesheetReviewsToCreate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimesheetReviewsToCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TimesheetReviewsToCreate>() {
           ...
           public TimesheetReviewsToCreate read(JsonReader in) throws IOException {
             ...
             TimesheetReviewsToCreate instance = thisAdapter.fromJsonTree(jsonObj);
